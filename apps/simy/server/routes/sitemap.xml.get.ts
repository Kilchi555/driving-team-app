export default defineEventHandler((event) => {
  ...
  const routes: { path: string; priority: string; changefreq: string; lastmod?: string }[] = [
    ...
    { path: '/coaching',                   priority: '0.9', changefreq: 'weekly',  lastmod: today },
    { path: '/consulting',                 priority: '0.9', changefreq: 'weekly',  lastmod: today },
    { path: '/personal-training',          priority: '0.9', changefreq: 'weekly',  lastmod: today },
    { path: '/nachhilfe',                  priority: '0.9', changefreq: 'weekly',  lastmod: today },
    { path: '/musikschule',                priority: '0.9', changefreq: 'weekly',  lastmod: today },
    { path: '/hundeschule',                priority: '0.9', changefreq: 'weekly',  lastmod: today },
    { path: '/massage',                    priority: '0.9', changefreq: 'weekly',  lastmod: today },

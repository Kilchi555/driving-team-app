...
export default defineEventHandler((event) => {
  const routes: { path: string; priority: string; changefreq: string }[] = [
    ...
    { path: '/fahrschule/schuelerportal', priority: '0.85', changefreq: 'monthly' },
    { path: '/fahrschule/dokumentation', priority: '0.85', changefreq: 'monthly' },
    { path: '/fahrschule/abholung', priority: '0.85', changefreq: 'monthly' },

export default defineNuxtConfig({
  ...
  routeRules: {
    '/': { prerender: true },
    '/branchen': { prerender: true },
    '/branchen/**': { prerender: true },
    '/coaching': { prerender: true },
    '/consulting': { prerender: true },
    '/personal-training': { prerender: true },
    '/nachhilfe': { prerender: true },
    '/musikschule': { prerender: true },
    '/hundeschule': { prerender: true },
    '/massage': { prerender: true },

...
const locations: Record<string, {
  ...
  zuerich: {
    city: 'Zürich',
    area: 'Zürich & Umgebung',
    name: 'Driving Team Zürich',
    street: 'Hohlstrasse 544',
    zip: '8048',
    canton: 'ZH',
    address: 'Hohlstrasse 544, 8048 Zürich',
  ...
  schlieren: {
    city: 'Schlieren',
    area: 'Schlieren & Limmattal',
    name: 'Bahnhof Schlieren',
    street: 'Bahnhofplatz',
    zip: '8952',
    canton: 'ZH',
    address: 'Bahnhofplatz, 8952 Schlieren',
    region: 'Schlieren, Urdorf, Birmensdorf, Dietikon, Spreitenbach, Altstetten',
    lat: '47.39936',
    lng: '8.44731',
  },
  uitikon: {
    city: 'Uitikon',
    area: 'Uitikon Waldegg & Umgebung',
    name: 'Zentrum Uitikon',
    street: 'Dorfstrasse',
    zip: '8142',
    canton: 'ZH',
    address: 'Dorfstrasse, 8142 Uitikon Waldegg',
    region: 'Uitikon, Ringlikon, Birmensdorf, Stallikon, Urdorf, Schlieren',
    lat: '47.36970',
    lng: '8.47630',
  },
  urdorf: {
    city: 'Urdorf',
    area: 'Urdorf & Limmattal',
    name: 'Bahnhof Glanzenberg',
    street: 'Beim Bahnhof Glanzenberg',
    zip: '8902',
    canton: 'ZH',
    address: 'Bahnhof Glanzenberg, 8902 Urdorf',
    region: 'Urdorf, Schlieren, Birmensdorf, Dietikon, Spreitenbach',
    lat: '47.39865',
    lng: '8.42136',
  },
  wettswil: {
    city: 'Wettswil',
    area: 'Wettswil & Knonaueramt',
    name: 'Bahnhof Bonstetten-Wettswil',
    street: 'Stationsstrasse 33',
    zip: '8906',
    canton: 'ZH',
    address: 'Stationsstrasse 33, 8906 Bonstetten',
    region: 'Wettswil, Bonstetten, Stallikon, Uitikon, Birmensdorf',
    lat: '47.32589',
    lng: '8.46776',
  },
  vku_zuerich: {
    city: 'Zürich',
    area: 'Zürich & Umgebung',
    name: 'Driving Team Zürich – VKU Lokal',

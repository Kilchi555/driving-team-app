    ...
    <div class="max-w-7xl mx-auto px-4">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
        <div class="text-center group">
          <div class="mb-4 text-4xl md:text-6xl font-black text-primary-400 group-hover:scale-125 transition-transform duration-500">15+</div>
          <p class="text-gray-300 text-lg">Jahre Erfahrung</p>
        </div>
        <div class="text-center group">
          <div class="mb-4 text-4xl md:text-6xl font-black text-green-400 group-hover:scale-125 transition-transform duration-500">8</div>
        ...
        <div class="text-center group">
          <div class="mb-4 text-4xl md:text-6xl font-black text-red-400 group-hover:scale-125 transition-transform duration-500">4.9 ⭐</div>

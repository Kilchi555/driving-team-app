<template>
  <section class="py-20" style="background: linear-gradient(180deg, #f8fbff 0%, #ffffff 100%)">
    <div class="section-container">

      <!-- Header -->
      <div class="text-center mb-4">
        <p class="text-xs font-bold tracking-[0.2em] uppercase text-primary-500 mb-3">Kundenstimmen</p>
        <h2 class="heading-md text-gray-900">{{ title }}</h2>
      </div>
      ...
      <div class="flex items-center justify-center gap-2 mb-10">
        ...
        <span class="text-sm text-gray-500 font-medium">4.9 · Google Bewertungen</span>
      </div>
      ...
      <div class="relative">
        <div
          ref="sliderRef"
          class="flex gap-5 overflow-x-auto snap-x snap-mandatory pb-4 -mx-4 pl-4 pr-4 scroll-pl-4 scrollbar-hide scroll-smooth"
        ...
        >
          <a
            ...
            class="snap-start shrink-0 w-[84vw] sm:w-[56vw] md:w-[38vw] lg:w-[27vw] max-w-[340px] block rounded-2xl p-6 no-underline bg-white border border-gray-100 shadow-[0_2px_20px_rgba(0,0,0,0.07)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_32px_rgba(1,158,229,0.18)] hover:border-primary-200 relative overflow-hidden group"
          >
            <!-- Decorative quote mark -->
            <span class="absolute top-3 right-4 text-7xl font-serif leading-none text-primary-100 group-hover:text-primary-200 transition-colors select-none pointer-events-none" aria-hidden="true">"</span>
            ...
            <!-- Review text -->
            <p class="text-gray-700 text-sm leading-relaxed [-webkit-line-clamp:4] [line-clamp:4] [-webkit-box-orient:vertical] [display:-webkit-box] overflow-hidden mb-5">{{ review.text }}</p>

            <!-- Author row -->
            <div class="flex items-center gap-3 pt-4 border-t border-gray-100">
              <div
                class="w-8 h-8 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0"
                style="background: linear-gradient(135deg, #019ee5, #0176b0)"
              >
                {{ review.author ? review.author.charAt(0).toUpperCase() : 'G' }}
              </div>
              <div class="min-w-0">
                <p class="text-sm font-semibold text-gray-900 truncate">{{ review.author }}</p>
                <p class="text-xs text-primary-500 font-medium">{{ linkText }}</p>
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="flex justify-center gap-2 mt-6">
          <button
            ...
            :class="i === activeIndex ? 'w-6 h-2 bg-primary-500' : 'w-2 h-2 bg-gray-200 hover:bg-gray-300'"
...
const _placeholders: Record<string, ReviewEntry[]> = {
  ...
  motorrad: [
    { text: '„Die Motorrad-Fahrstunden bei Pascal waren extrem lehrreich und massgeblich für meine erfolgreiche Motorrad-Führerprüfung. Die Fahrschule, sowie Pascal als Fahrlehrer, kann ich nur wärmstens empfehlen. Sehr kompetent, sympathisch und freundlich."', author: 'Filip B.', link: 'https://maps.app.goo.gl/pQeWXsGGTuSZW45d8' },
    { text: '„Motorrad-Prüfung bestanden! Danke Pascal! Der Grundkurs und die Fahrstunden waren sehr lehrreich und haben vor allem auch Spass gemacht. Pascals ruhige und gelassene Art vermittelt Sicherheit. Liebes Driving Team, macht weiter so!"', author: 'Irena D.', link: 'https://maps.app.goo.gl/utGTjstBEJJHsTCs5' },
    ...
    { text: '„Ich kann die Fahrschule nur weiter empfehlen, habe bei der Fahrschule Kategorie B und A erfolgreich abgeschlossen. Vito und Pascal sind wirklich tolle Fahrlehrer und nehmen sich immer Zeit für euch."', author: 'Cristian A.', link: 'https://maps.app.goo.gl/Xb18G3mEymJjCoweA' },
  ],
  'motorrad-grundkurs': [
    { text: '„Die Motorrad-Fahrstunden bei Pascal waren extrem lehrreich und massgeblich für meine erfolgreiche Motorrad-Führerprüfung. Die Fahrschule, sowie Pascal als Fahrlehrer, kann ich nur wärmstens empfehlen. Sehr kompetent, sympathisch und freundlich."', author: 'Filip B.', link: 'https://maps.app.goo.gl/pQeWXsGGTuSZW45d8' },
    { text: '„Wir können die Fahrschule Driving Team Zürich wärmstens empfehlen. Vito ist ein super toller Fahrlehrer, der über viel Einfühlvermögen verfügt und seine langjährige Erfahrungen sehr gut weitergeben kann. Der Grundkurs hat sehr viel Spass gemacht!"', author: 'Kpsc', link: 'https://maps.app.goo.gl/2BPHzr6DBZg74RSQ6' },
    { text: '„Ich kann die Fahrschule nur weiter empfehlen, habe bei der Fahrschule Kategorie B und A erfolgreich abgeschlossen. Vito und Pascal sind wirklich tolle Fahrlehrer und nehmen sich immer Zeit für euch."', author: 'Cristian A.', link: 'https://maps.app.goo.gl/Xb18G3mEymJjCoweA' },
    { text: '„Ich habe den Grundkurs fürs Motorrad bei Driving Team Zürich absolviert. Es hat sehr Spass gemacht und ich habe vieles dazu gelernt. Vito ist wie eine Nadel im Heuhaufen, genau so einen Fahrlehrer wünschen sich alle."', author: 'Marco C.', link: 'https://maps.app.goo.gl/ARqgauxXaNGpXg6k8' },
    { text: '„Motorrad-Prüfung bestanden! Danke Pascal! Der Grundkurs und die Fahrstunden waren sehr lehrreich und haben vor allem auch Spass gemacht. Pascals ruhige und gelassene Art vermittelt Sicherheit. Liebes Driving Team, macht weiter so!"', author: 'Irena D.', link: 'https://maps.app.goo.gl/utGTjstBEJJHsTCs5' },
  ],
  motorboot: [

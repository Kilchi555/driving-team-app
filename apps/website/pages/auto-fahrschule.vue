<template>
  <div>
    <Head>
      <Title>Auto Fahrstunden Zürich - ab CHF 95/Lektion | Driving Team</Title>
    ...
    <section class="bg-gradient-to-br from-primary-500 to-primary-700 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/categories/auto-fahrschule-hero.webp" alt="Auto Fahrschule Zürich - Kategorie B Fahrstunden mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" />
      <div class="absolute inset-0 bg-black/40"></div>
      <div class="section-container relative z-10">
        <div class="max-w-3xl">
          <h1 class="heading-lg text-white mb-6">Auto Fahrschule Kategorie B</h1>
          <p class="hidden xs:block text-xl text-white/90 mb-8">Träumst du davon, die Freiheit auf vier Rädern zu erleben? Dann bist du bei unserer Auto Fahrschule genau richtig! Wir wissen, dass der Weg zum Auto Führerschein der Kategorie B nicht nur sicher, sondern auch angenehm sein sollte.</p>
          <a href="https://simy.ch/booking/availability/driving-team?service=B" target="_blank" rel="noopener noreferrer" class="btn-primary bg-white text-primary-600 hover:bg-primary-50 text-lg">
            ✨ Jetzt Termin buchen
          </a>
        </div>
      </div>

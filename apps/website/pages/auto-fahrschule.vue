<template>
  <div>
    ...
    <section class="bg-gradient-to-br from-primary-500 to-primary-700 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/categories/auto-fahrschule-hero.webp" alt="Auto Fahrschule – Kategorie B Fahrstunden mit Driving Team in Zürich" class="absolute inset-0 w-full h-full object-cover opacity-100" />
    ...
    <section class="bg-gray-50 py-16">
      <div class="section-container">
        <h2 class="text-xl md:text-3xl lg:text-4xl font-bold mb-12 text-center">Weg zur Autoprüfung - In 7 Schritten zur Autoprüfung</h2>
        ...
        <div class="space-y-8 max-w-4xl mx-auto">
          ...
          <details class="bg-white rounded-lg border-l-4 border-primary-600 shadow-sm group">
            <summary class="flex items-start gap-4 md:gap-6 p-4 md:p-8 cursor-pointer list-none select-none">
              ...
              <div class="flex-1 flex items-center justify-between">
                <h3 class="text-base md:text-lg lg:text-xl font-bold">Lernfahrgesuch Auto</h3>
                <span class="text-gray-400 group-open:rotate-180 transition-transform duration-200 flex-shrink-0 ml-2 md:ml-4 text-lg">▼</span>
              </div>
            </summary>
            <div class="px-4 md:px-8 pb-4 md:pb-6 ml-14 md:ml-[72px]">
          ...
          <details class="bg-white rounded-lg border-l-4 border-primary-600 shadow-sm group">
            <summary class="flex items-start gap-4 md:gap-6 p-4 md:p-8 cursor-pointer list-none select-none">
              ...
              <div class="flex-1 flex items-center justify-between">
                <h3 class="text-base md:text-lg lg:text-xl font-bold">Auto Fahrstunden</h3>
                <span class="text-gray-400 group-open:rotate-180 transition-transform duration-200 flex-shrink-0 ml-2 md:ml-4 text-lg">▼</span>
              </div>
            </summary>
            <div class="px-4 md:px-8 pb-4 md:pb-6 ml-14 md:ml-[72px]">
          ...
          <details class="bg-white rounded-lg border-l-4 border-primary-600 shadow-sm group">
            <summary class="flex items-start gap-4 md:gap-6 p-4 md:p-8 cursor-pointer list-none select-none">
              ...
              <div class="flex-1 flex items-center justify-between">
                <h3 class="text-base md:text-lg lg:text-xl font-bold">Praktische Autofahrprüfung</h3>
                <span class="text-gray-400 group-open:rotate-180 transition-transform duration-200 flex-shrink-0 ml-2 md:ml-4 text-lg">▼</span>
              </div>
            </summary>
            <div class="px-4 md:px-8 pb-4 md:pb-6 ml-14 md:ml-[72px]">
          ...
          <details class="bg-white rounded-lg border-l-4 border-primary-600 shadow-sm group">
            <summary class="flex items-start gap-4 md:gap-6 p-4 md:p-8 cursor-pointer list-none select-none">
              ...
              <div class="flex-1 flex items-center justify-between">
                <h3 class="text-base md:text-lg lg:text-xl font-bold">WAB Kurs</h3>
                <span class="text-gray-400 group-open:rotate-180 transition-transform duration-200 flex-shrink-0 ml-2 md:ml-4 text-lg">▼</span>
              </div>
            </summary>
            <div class="px-4 md:px-8 pb-4 md:pb-6 ml-14 md:ml-[72px]">
    ...
    <section class="section-container">
      ...
      <div class="max-w-3xl mx-auto space-y-4 mb-12">
        <details class="bg-gray-50 border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
          ...
          <p class="text-gray-600 mt-4">Das ist unterschiedlich und hängt von deinem Alter, Erfahrung und Lerntempo ab. Im Durchschnitt benötigen unsere Schüler 15-20 Fahrstunden. Wir beraten dich gerne individuell.</p>
        </details>
        ...
        <details class="bg-gray-50 border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
          ...
          <p class="text-gray-600 mt-4">Optimal wären 2-4 Fahrten pro Woche. Das heisst nicht unbedingt 2-4 Fahrlektionen, sondern z.B. 1 Fahrlektion und 1 Mal privat repetieren mit einer Begleitperson.</p>
        </details>
    ...
    <section class="section-container py-12 bg-gray-50">
      <div class="max-w-4xl mx-auto">
        ...
        <p class="text-gray-600 mb-8">
          Vergleiche die Auto Fahrschule mit anderen Fahrzeugklassen oder finde einen Standort in deiner Nähe.
        </p>
...
const jsonLdScripts = [
  ...
  { type: 'application/ld+json', innerHTML: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Wieviele Fahrstunden benötige ich?", "acceptedAnswer": {"@type": "Answer", "text": "Das ist unterschiedlich und hängt von deinem Alter, Erfahrung und Lerntempo ab. Im Durchschnitt benötigen unsere Schüler 15-20 Fahrstunden. Wir beraten dich gerne individuell."}}, {"@type": "Question", "name": "Wie kann ich meine Fahrausbildung beschleunigen?", "acceptedAnswer": {"@type": "Answer", "text": "Optimal wären 2-4 Fahrten pro Woche. Das heisst nicht unbedingt 2-4 Fahrlektionen, sondern z.B. 1 Fahrlektion und 1 Mal privat repetieren mit einer Begleitperson."}}, {"@type": "Question", "name": "Wieso dauert die Fahrstunde 45 Minuten?", "acceptedAnswer": {"@type": "Answer", "text": "Nach 45 Minuten lässt die Konzentration nach. Dies ist auch an Schulen Standard. Je nach Übungsgebiet können Fahrstunden auch länger ausfallen."}}, {"@type": "Question", "name": "Was kostet der Führerschein Kategorie B insgesamt?", "acceptedAnswer": {"@type": "Answer", "text": "Die Gesamtkosten für einen Führerschein der Kategorie B betragen in der Schweiz durchschnittlich CHF 3'500–3'600. Dies beinhaltet den Nothelferkurs (ca. CHF 100), Sehtest (CHF 50), Lernfahrausweis (CHF 80), Theorieprüfung (CHF 40), VKU-Kurs (CHF 200–300), Fahrstunden (durchschnittlich 15–20 à CHF 100–120), praktische Prüfung (CHF 130) und WAB-Kurs (CHF 350). Die genauen Kosten hängen von der Anzahl der benötigten Fahrstunden ab."}}, {"@type": "Question", "name": "Was sind die Voraussetzungen für den Führerschein?", "acceptedAnswer": {"@type": "Answer", "text": "Um einen Führerschein der Kategorie B zu erhalten, benötigst du: Mindestalter von 18 Jahren (oder 17 Jahre beim begleiteten Fahren), einen bestandenen Nothelferkurs (obligatorisch), einen bestandenen Sehtest, einen gültigen Lernfahrausweis und die Anmeldung in einer Fahrschule. Du musst zudem in der Schweiz wohnhaft sein und einen gültigen Ausweis haben."}}, {"@type": "Question", "name": "Wie lange dauert die komplette Fahrausbildung?", "acceptedAnswer": {"@type": "Answer", "text": "Die Dauer der Fahrausbildung hängt von deinem Tempo und Lernfortschritt ab. Die Theorieausbildung dauert typischerweise 6–8 Wochen mit 12 Unterrichtsabenden à 90 Minuten. Die praktische Ausbildung mit 15–20 Fahrstunden dauert 2–4 Monate. Insgesamt solltest du mit 4–6 Monaten rechnen, wenn du zügig voranschreitest und regelmässig trainingst."}}, {"@type": "Question", "name": "Was ist der VKU Kurs und ist er obligatorisch?", "acceptedAnswer": {"@type": "Answer", "text": "Der VKU (Verkehrskundeunterricht) ist ein obligatorischer 8-stündiger Kurs, den du absolvieren musst, bevor du zur praktischen Prüfung antreten kannst. Der Kurs findet an zwei Tagen zu je 4 Stunden statt und behandelt Themen wie Verkehrssicherheit, Verhaltensregeln und praktisches Wissen. Er ist eine wichtige Vorbereitung auf die Prüfung und kostet etwa CHF 200–300."}}, {"@type": "Question", "name": "Kann ich bereits mit 17 Jahren fahren?", "acceptedAnswer": {"@type": "Answer", "text": "Ja! In der Schweiz gibt es die Möglichkeit des begleiteten Fahrens ab 17 Jahren. Dafür benötigst du einen speziellen Lernfahrausweis (ab 17 Jahren möglich). Du darfst dann fahren, wenn eine Begleitperson (mindestens 24 Jahre alt, mit gültigem Führerschein) im Fahrzeug sitzt. Dies ermöglicht dir, bereits früher praktische Fahrerfahrung zu sammeln."}}, {"@type": "Question", "name": "Was kostet eine Fahrstunde bei euch?", "acceptedAnswer": {"@type": "Answer", "text": "Eine Fahrstunde (45 Minuten) kostet bei uns CHF 100–120, je nach Kurs- und Zeittyp. Wir bieten auch günstigere Abo-Preise an: Bei 5 Fahrstunden sparst du gegenüber Einzellektionen. Zusätzlich fallen eine Versicherungspauschale (CHF 120 einmalig) und der WarmUp + Prüfungsfahrt Kurs (CHF 285) an. Kontaktiere uns für aktuelle Preise und individuelle Angebote."}}, {"@type": "Question", "name": "Was tun bei Durchfall der praktischen Prüfung?", "acceptedAnswer": {"@type": "Answer", "text": "Wenn du die praktische Prüfung nicht bestehst, ist das kein Problem – viele benötigen einen zweiten Versuch! Wir helfen dir gerne mit zusätzlichen Fahrstunden, um deine Schwachstellen zu verbessern. Dein Lernfahrausweis bleibt 24 Monate gültig, du kannst die Prüfung beliebig oft wiederholen. Eine Wiederholungsprüfung kostet CHF 130 und kann frühestens nach einer Woche erneut angemeldet werden."}}, {"@type": "Question", "name": "Muss ich einen Erste-Hilfe-Kurs machen?", "acceptedAnswer": {"@type": "Answer", "text": "Ja, der Nothelferkurs (Erste-Hilfe-Kurs) ist obligatorisch und eine Voraussetzung für den Führerschein. Der Kurs dauert etwa 3–4 Stunden und vermittelt essenzielle Notfallmassnahmen. Dein Nothelferkurs-Zertifikat ist ab dem Ausstellungsdatum 6 Jahre gültig. Der Kurs kostet etwa CHF 100–150 und kann bei verschiedenen Organisationen absolviert werden."}}]}) },
]
...
const autoBenefits = [
  {
    ...
    description: 'Wir begleiten dich von der ersten Stunde an und bringen dir alles bei, was du für deinen Führerschein der Kategorie B benötigst.'
  },
  {
  ...
  },
  {
    ...
    description: 'Bereite dich optimal auf die Autoprüfung vor, damit am grossen Tag nichts schiefgeht.'
  },
  {
    title: 'Auffrischungskurs?',
    description: 'Auch wenn du bereits im Besitz des Auto Führerausweises bist und deine Fahrfähigkeiten auffrischen möchtest, bist du in unseren Auto Fahrstunden bestens aufgehoben.'
  }
]
</script>

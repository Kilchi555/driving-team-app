<template>
  <div>
    <Head>
      <Title>CZV Kurse – Weiterbildung für LKW & Bus | Driving Team</Title>
      <Meta name="description" content="CZV Pflichtweiterbildung für Berufschauffeure – Grundkurs und 5 Kurse in 5 Jahren ab CHF 190.-/Tag in Zürich und Lachen. Jetzt informieren!" />
    ...
    <section class="section-container">
      <h2 class="heading-md mb-8 text-center">Was ist CZV?</h2>
      <div class="max-w-3xl mx-auto space-y-4 text-gray-700">
        <p>Die Grundausbildung und Weiterbildung für Berufschauffeure ist in der CZV (Chauffeurszulassungsverordnung) geregelt. Sie gilt für professionelle Fahrer der Kategorien C1, C, C1E, CE (Lastwagen) und D1, D, D1E, DE (Bus).</p>
        <p>Das Ziel der CZV ist es, die Verkehrssicherheit durch qualifizierte, gut ausgebildete Berufschauffeure zu verbessern und die Arbeitsbedingungen im Transportgewerbe zu fördern.</p>
      </div>
    </section>
    ...
    <!-- Kursinhalte CZV Weiterbildung -->
    <section class="section-container">
      <h2 class="heading-md mb-10 text-center">CZV Weiterbildung – Kursthemen</h2>
      <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-4xl mx-auto">
        <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          <h3 class="font-bold text-gray-900 mb-2">🛡️ Prävention</h3>
          <p class="text-gray-600 text-sm">Unfallverhütung, sicheres Fahren, Vermeidung von Risikosituationen im Strassenverkehr.</p>
        </div>
        <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          <h3 class="font-bold text-gray-900 mb-2">❤️ Traffic Health</h3>
          <p class="text-gray-600 text-sm">Gesundheit am Steuer, Ergonomie, Stressmanagement für Berufschauffeure.</p>
        </div>
        <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          <h3 class="font-bold text-gray-900 mb-2">📋 ARV1</h3>
          <p class="text-gray-600 text-sm">Arbeits-, Lenk- und Ruhezeiten für Lastwagenfahrer. Gesetzliche Grundlagen und Praxis.</p>
        </div>
        <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          <h3 class="font-bold text-gray-900 mb-2">🔧 Radwechsel & Feuerlöschen</h3>
          <p class="text-gray-600 text-sm">Praktische Übungen zum korrekten Radwechsel und Umgang mit Feuerlöschern.</p>
        </div>
        <div class="bg-white rounded-lg p-6 shadow-sm border border-gray-100">
          <h3 class="font-bold text-gray-900 mb-2">📍 Details</h3>
          <ul class="text-gray-600 text-sm space-y-1">
            <li>💰 CHF 190.- pro Kurstag</li>
    ...
    <section class="section-container py-20 bg-gray-50">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 gap-6">
          ...
          <a href="/fahrschule-spreitenbach/" class="bg-white rounded-lg p-6 border border-gray-200 hover:shadow-lg hover:border-primary-400 transition">

<template>
  <div>
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <NuxtImg src="/images/locations/pfaeffikon-hero.webp" alt="Fahrstunden in Pfäffikon/SZ – Auto, Motorrad, Lastwagen, Bus und Anhänger mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" loading="eager" fetchpriority="high" sizes="100vw" width="1920" height="1080" />

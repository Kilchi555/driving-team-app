...
const jsonLdScripts = [
  { type: 'application/ld+json', innerHTML:  JSON.stringify({ "@context": "https://schema.org", "@type": "LocalBusiness", "name": "Driving Team Fahrschule Pfäffikon/SZ", "description": "Professionelle Fahrausbildung in Pfäffikon SZ.", "url": "https://drivingteam.ch/fahrschule-pfaeffikon/", "telephone": "+41444310033", "address": { "@type": "PostalAddress", "addressLocality": "Pfäffikon", "postalCode": "8808", "addressCountry": "CH" }, "openingHours": "Mo-Fr 08:00-19:00", "image": "https://drivingteam.ch/images/locations/pfaeffikon-hero.webp", "priceRange": "CHF 100-200", "sameAs": ["https://drivingteam.ch"] }) },
  { type: 'application/ld+json', innerHTML:  JSON.stringify({ "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://drivingteam.ch/" }, { "@type": "ListItem", "position": 2, "name": "Fahrschule Pfäffikon/SZ", "item": "https://drivingteam.ch/fahrschule-pfaeffikon/" }] }) },
]

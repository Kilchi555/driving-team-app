...
const jsonLdScripts = [
  { type: 'application/ld+json', innerHTML: JSON.stringify({ "@context": "https://schema.org", "@type": "Course", "name": "Anhänger Fahrschule Kategorie BE", "description": "Professionelle Anhänger Fahrausbildung für Kategorie BE mit flexiblen Fahrstunden", "url": "https://drivingteam.ch/anhaenger-fahrschule/", "provider": { "@type": "Organization", "name": "Driving Team", "url": "https://drivingteam.ch" }, "offers": { "@type": "Offer", "priceCurrency": "CHF", "url": "https://simy.ch/booking/availability/driving-team" } }) },
  { type: 'application/ld+json', innerHTML: JSON.stringify({ "@context": "https://schema.org", "@type": "AggregateRating", "itemReviewed": { "@type": "Course", "name": "Anhänger Fahrschule Kategorie BE", "url": "https://drivingteam.ch/anhaenger-fahrschule/" }, "ratingValue": 4.9, "bestRating": 5, "worstRating": 1, "ratingCount": 366, "reviewCount": 366 }) },

      ...
      <div class="section-container">
        ...
        <div class="max-w-3xl mx-auto space-y-4">
          ...
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
            ...
            <p class="text-gray-600 mt-4 text-sm">Der Treffpunkt für den Motorrad-Grundkurs von Driving Team befindet sich direkt vor unserem Lokal in Zürich: Vulkanstrasse 130b, 8048 Zürich. Dort wirst du zu Beginn des Kurses von unseren Instruktoren begrüsst und erhältst alle notwendigen Informationen zum Kursablauf.</p>
          </details>
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">

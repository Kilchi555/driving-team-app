<template>
  <div>
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img
        :src="`/_vercel/image?url=%2Fimages%2Fcourses%2Fmotorrad-grundkurs-hero.webp&w=828&q=60`"
        :srcset="`/_vercel/image?url=%2Fimages%2Fcourses%2Fmotorrad-grundkurs-hero.webp&w=640&q=55 640w, /_vercel/image?url=%2Fimages%2Fcourses%2Fmotorrad-grundkurs-hero.webp&w=828&q=60 828w, /_vercel/image?url=%2Fimages%2Fcourses%2Fmotorrad-grundkurs-hero.webp&w=1080&q=60 1080w`"
        sizes="100vw"
        alt="Motorrad Grundkurs – Sicheres Fahren auf zwei Rädern lernen mit Driving Team"

<template>
  <div>
    <Head>
      <Title>Fahrschule Lachen SZ | ab CHF 100.- | Auto, Motorrad, Lastwagen | Driving Team</Title>
      <Meta name="description" content="Fahrschule Lachen SZ ✓ ab CHF 100.-/Lektion ✓ Auto, Motorrad, Anhänger, Lastwagen, Bus ✓ Flexible Zeiten & Treffpunkte ✓ Kanton Schwyz ✓ 85% Erfolgsquote. Jetzt anmelden!" />
      ...
      <Meta property="og:title" content="Fahrschule Lachen SZ | ab CHF 100.- | Auto, Motorrad & mehr | Driving Team" />
      <Meta property="og:description" content="Professionelle Fahrausbildung in Lachen SZ. Auto, Motorrad, Lastwagen & Kurse. Ab CHF 100.-/Lektion. Flexible Zeiten & Treffpunkte im Kanton Schwyz." />
      ...
      <Meta name="twitter:title" content="Fahrschule Lachen SZ | ab CHF 100.- | Driving Team" />
      <Meta name="twitter:description" content="Fahrschule Lachen SZ. Auto, Motorrad, Anhänger, Lastwagen, Bus. Ab CHF 100.-/Lektion. Flexible Zeiten. Prüfung Pfäffikon SZ. Jetzt anmelden!" />
      <Meta name="robots" content="index, follow, max-snippet:-1, max-image-preview:large, max-video-preview:-1" />
      <Meta name="date" :content="new Date().toISOString()" />
    </Head>

    <!-- Breadcrumb -->
    <BreadcrumbNav :breadcrumbs="[{ label: 'Fahrschule', href: '/' }, { label: 'Fahrschule Lachen SZ' }]" />
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/locations/lachen-hero.webp" alt="Fahrstunden in Lachen/SZ – Auto, Motorrad, Anhänger und Motorboot mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" />
      ...
      <div class="section-container relative z-10">
        <div class="max-w-3xl">
          ...
          <p class="hidden xs:block text-xl text-white mb-8">Deine moderne Fahrschule in Lachen/SZ. Melde Dich an und starte deine Fahrausbildung mit erfahrenen Fahrlehrern.</p>
    ...
    <!-- 2. Features (weiß) -->
    <FeatureSection
      title="Warum Driving Team Lachen?"
      subtitle="Melde Dich in unserer Fahrschule Lachen an und Du kannst folgende Punkte von uns erwarten…"
...
const jsonLdScripts = [
  { type: 'application/ld+json', innerHTML: JSON.stringify({
    ...
    "description": "Professionelle Fahrausbildung in Lachen SZ für alle Fahrzeugkategorien. Auto, Motorrad, Anhänger, Lastwagen, Bus. Ab CHF 100.-/Lektion, flexible Treffpunkte.",
  ...
  { type: 'application/ld+json', innerHTML: JSON.stringify({
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Fahrschule Lachen SZ", "item": "https://drivingteam.ch/fahrschule-lachen/" }
    ]
  }) },
  { type: 'application/ld+json', innerHTML: JSON.stringify({
    "@context": "https://schema.org",
    ...
    "mainEntity": [
      ...
      { "@type": "Question", "name": "Was kosten Fahrstunden in Lachen?", "acceptedAnswer": { "@type": "Answer", "text": "Fahrstunden starten ab CHF 100.-/45min. Hinzu kommt eine einmalige Admin- und Versicherungspauschale für die gesamte Fahrausbildung." } },

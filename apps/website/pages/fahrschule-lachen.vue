      ...
      <div class="section-container relative z-10">
        ...
        <div class="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <div class="bg-white rounded-lg p-6 shadow-sm">
            <h3 class="font-bold text-gray-900 mb-3">📚 Vorschulung</h3>
            <p class="text-gray-600 text-sm">Vorbereitung im Stand, Blick- und Lenktechnik, Gas, Bremsen, Schaltung (Manuell/Automatik), Blicksystematik, Armaturen, Fahrzeugsicherung</p>
          </div>
          <div class="bg-white rounded-lg p-6 shadow-sm">
            <h3 class="font-bold text-gray-900 mb-3">🚗 Grundschulung</h3>
            <p class="text-gray-600 text-sm">Berganfahren, Einspuren, Abbiegen, Mehrfachblick, Kreisverkehr, Lichtsignale, Lückenbenützung</p>
          </div>
          <div class="bg-white rounded-lg p-6 shadow-sm">
            <h3 class="font-bold text-gray-900 mb-3">🏙️ Hauptschulung</h3>
            <p class="text-gray-600 text-sm">Rechtsvortritt, Stop/Kein Vortritt, Bus/Tram, Bergstrassen, Stadtverkehr</p>
          </div>
          <div class="bg-white rounded-lg p-6 shadow-sm">
            <h3 class="font-bold text-gray-900 mb-3">🛣️ Perfektionsschulung</h3>
            <p class="text-gray-600 text-sm">Wegweiser/Signalisation, Autobahn, Selbständiges Fahren</p>
          </div>
          <div class="bg-white rounded-lg p-6 shadow-sm">
            <h3 class="font-bold text-gray-900 mb-3">🔄 Manöver</h3>
            <p class="text-gray-600 text-sm">Fahrzeugsicherung, Rückwärtsfahren, Wenden, Rechtwinklig & seitwärts parkieren, Schnelle & sichere Bremsung</p>
          </div>
        </div>
      </div>
    </section>

<template>
  <div>
    <Head>
      ...
      <Meta name="description" content="Motorrad fahren lernen in Zürich – A1, A35kW & A mit erfahrenen Fahrlehrern. Grundkurse & Fahrstunden, ab CHF 95.-. Jetzt anmelden!" />
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      ...
      <div class="section-container relative z-10">
        <div class="max-w-3xl">
          ...
          <p class="text-base xs:text-xl text-white mb-8">Bist du bereit, die Strasse mit deinem Motorrad zu erobern? Unsere Motorrad Fahrschule bietet dir professionelle Ausbildung für alle Kategorien (A1, A35kW, A) mit erfahrenen Fahrlehrern in Zürich und Lachen/SZ.</p>
      ...
      <div class="section-container">
        ...
        <div class="max-w-3xl mx-auto bg-white rounded-lg p-8 shadow-sm">
          ...
          <div class="mt-6 p-4 bg-primary-50 rounded-lg">
            <p class="text-sm text-primary-800">Du bist noch nie Motorrad gefahren? Kein Problem! Wir begleiten dich sicher auf deinen ersten Metern. Bitte bringe dein eigenes betriebssicheres Motorrad sowie Helm und Schutzausrüstung mit.</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="space-y-8 max-w-4xl mx-auto">
        ...
        <details class="bg-white rounded-lg border-l-4 border-primary-600 shadow-sm group">
          ...
          <div class="px-4 md:px-8 pb-4 md:pb-6 ml-14 md:ml-[72px]">
              ...
              <p class="text-sm text-gray-600 mt-2">Bitte bringe dein eigenes betriebssicheres Motorrad sowie Helm und Schutzausrüstung mit. Für die Prüfungsvorbereitung empfehlen wir, den letzten Schliff bei deinem Motorrad Fahrlehrer zu holen.</p>
    ...
    <section class="section-container">
      ...
      <div class="max-w-3xl mx-auto space-y-4 mb-12">
        ...
        <details class="bg-gray-50 border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
          <summary class="font-semibold text-lg text-gray-900 flex justify-between items-center">
            Brauche ich ein eigenes Motorrad?
            <span class="text-primary-500 group-open:rotate-180 transition">▼</span>
          </summary>
          <p class="text-gray-600 mt-4">Ja. Für Fahrstunden und Grundkurs brauchst du ein eigenes betriebssicheres Motorrad sowie eigenen Helm und Schutzausrüstung.</p>
        </details>
    ...
    <section class="bg-gray-50 py-16">
      <div class="section-container">
        ...
        <div class="grid md:grid-cols-3 gap-8 mb-12">
          ...
          <div class="bg-white rounded-lg p-8 shadow-sm">
            <p class="text-4xl mb-4">⚡</p>
            <h3 class="font-bold text-lg mb-2">Eigenes Motorrad & Helm</h3>
            <p class="text-gray-600">Für Fahrstunden und Grundkurs brauchst du ein eigenes betriebssicheres Motorrad sowie eigenen Helm und Schutzausrüstung.</p>
          </div>
          <div class="bg-white rounded-lg p-8 shadow-sm">
            <p class="text-4xl mb-4">✅</p>

  ...
  <div>
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16 md:py-24">
      <div class="section-container">
        <div class="max-w-3xl">
          ...
          <p class="text-xl text-white mb-8">{{ categoryData.description }}</p>
    ...
    <section class="bg-primary-600 text-white py-16">
      <div class="section-container text-center">
        ...
        <p class="text-xl text-white mb-8">Reserviere jetzt deinen Termin – kein Risiko, unverbindliches Angebot!</p>
        <button @click="goToBooking" class="btn-primary bg-white text-primary-600 hover:bg-primary-50 text-lg">
          📅 Termin buchen
        </button>
      </div>

<template>
  <div>
    <Head>
      ...
      <Meta name="description" content="Mit Fahrlehrer Skender ab Bahnhof Dietikon zur Prüfung. Ab CHF 95.-, dreisprachig (DE/EN/AL), Prüfung Albisgütli oder Regensdorf. Jetzt anmelden!" />
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/locations/dietikon-hero.webp" alt="Fahrstunden in Dietikon – Auto und Anhänger Fahrschule mit erfahrenen Fahrlehrern" class="absolute inset-0 w-full h-full object-cover opacity-100" fetchpriority="high" loading="eager" width="1920" height="1080" />
    ...
    <section class="py-10 bg-gray-50 text-center">
      <div class="section-container">
        ...
        <PriceCalculator title="Kostenrechner Fahrschule Dietikon" />
      </div>
    </section>
    ...
    <div class="bg-gray-50">
      <LazyStandortMapSection location-key="dietikon" />
    </div>
...
const jsonLdScripts = [
  { type: 'application/ld+json', innerHTML: JSON.stringify({ "@context": "https://schema.org", "@type": ["DrivingSchool", "LocalBusiness"], "name": "Driving Team Fahrschule Dietikon", "description": "Professionelle Fahrausbildung in Dietikon im Limmattal. Unterricht auf Deutsch und Albanisch.", "url": "https://drivingteam.ch/fahrschule-dietikon/", "telephone": "+41444310033", "address": { "@type": "PostalAddress", "addressLocality": "Dietikon", "postalCode": "8953", "addressCountry": "CH" }, "openingHours": "Mo-Fr 08:00-19:00", "image": "https://drivingteam.ch/images/locations/dietikon-hero.webp", "priceRange": "CHF 100-200", "sameAs": ["https://drivingteam.ch"] }) },
  { type: 'application/ld+json', innerHTML: JSON.stringify({ "@context": "https://schema.org", "@type": "AggregateRating", "itemReviewed": { "@type": "LocalBusiness", "name": "Driving Team Fahrschule Dietikon", "url": "https://drivingteam.ch/fahrschule-dietikon/" }, "ratingValue": 5.0, "bestRating": 5, "worstRating": 1, "ratingCount": 4, "reviewCount": 4 }) },

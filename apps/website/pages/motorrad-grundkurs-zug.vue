  ...
  <div>
    ...
    <section class="bg-gray-50 py-16">
      <div class="section-container">
        ...
        <div class="max-w-4xl mx-auto mt-6 rounded p-4 text-xs text-gray-500">
    ...
    <section class="bg-gray-50 py-16">
      <div class="section-container">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div class="bg-white rounded-lg p-6 shadow-sm">
            <p class="text-gray-600 text-sm italic mb-4">«Sehr kompetenter und netter Motorradfahrlehrer. Ist auf alle Fragen eingegangen. Es gab gute Übungen. Sehr viele Tricks und Tipps erhalten. Habe den Motorrad Grundkurs besucht, mit einer Harley Superlow. Gut gemacht! Weiter so!»</p>
    ...
    <section class="section-container">
      ...
      <div class="max-w-3xl mx-auto space-y-4">
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie viele Stunden umfasst der Motorrad-Grundkurs bei Driving Team in Zug?<span class="text-gray-400 transition-transform group-open:rotate-180 duration-200">▼</span></summary>
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie kann ich mich für einen Motorrad-Grundkurs bei Driving Team anmelden?<span class="text-gray-400 transition-transform group-open:rotate-180 duration-200">▼</span></summary>
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie viel kostet der Motorrad-Grundkurs bei Driving Team in Zug?<span class="text-gray-400 transition-transform group-open:rotate-180 duration-200">▼</span></summary>

<template>
  <div>
    ...
    <!-- FAQ -->
    <section class="section-container">
      <h2 class="heading-md mb-10 text-center">Die häufigsten Fragen bezüglich Motorrad Grundkurs</h2>
      <div class="max-w-3xl mx-auto space-y-4">
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie viele Stunden umfasst der Motorrad-Grundkurs bei Driving Team in Zug?<span class="text-primary-500 group-open:rotate-180 transition hover:text-primary-700">▼</span></summary>
          <p class="text-gray-600 mt-4 text-sm">Der Motorrad-Grundkurs bei Driving Team in Zug umfasst insgesamt 12 Stunden, aufgeteilt in 3 Kursteile à 4 Stunden. Diese Struktur gewährleistet eine umfassende Ausbildung in allen wichtigen Bereichen des Motorradfahrens.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Für den Motorrad-Grundkurs bei Driving Team in Zug musst du dein eigenes betriebssicheres Motorrad oder deinen Roller mitbringen.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Ja, beim Driving Team Zug ist es erforderlich, dass Teilnehmende ihre eigene Motorrad-Sicherheitsbekleidung, einschliesslich eines Motorradhelms, mitbringen.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie kann ich mich für einen Motorrad-Grundkurs bei Driving Team anmelden?<span class="text-primary-500 group-open:rotate-180 transition hover:text-primary-700">▼</span></summary>
          <p class="text-gray-600 mt-4 text-sm">Die Anmeldung für einen Motorrad-Grundkurs bei Driving Team in Zug ist einfach und unkompliziert. Klicke auf einen der «Jetzt anmelden»-Buttons auf dieser Seite. Solltest du Fragen haben, stehen wir dir jederzeit per E-Mail oder telefonisch zur Verfügung.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie viel kostet der Motorrad-Grundkurs bei Driving Team in Zug?<span class="text-primary-500 group-open:rotate-180 transition hover:text-primary-700">▼</span></summary>
          <p class="text-gray-600 mt-4 text-sm">Bei Driving Team in Zug beträgt die Gebühr für jeden Kursteil des Motorrad-Grundkurses CHF 200.-. Die gesamten Kurskosten kannst du direkt am ersten Kurstag bar bezahlen.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Ja, bei Driving Team in Zug verstehen wir, dass Pläne sich ändern können. Frühzeitige Umbuchungen oder Absagen sind daher kostenlos möglich. Bei Umbuchungen oder Absagen weniger als 14 Tage vor Kursbeginn erheben wir eine Umtriebsentschädigung von CHF 80.-.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Der Treffpunkt für den Motorrad-Grundkurs befindet sich direkt vor dem Standort der Fahrschule Schoch in Steinhausen: Sennweidstrasse 30, 6312 Steinhausen.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Was passiert bei schlechtem Wetter?<span class="text-primary-500 group-open:rotate-180 transition hover:text-primary-700">▼</span></summary>
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Der Motorrad-Grundkurs bei Driving Team in Zug wird grundsätzlich in Deutsch durchgeführt. Auf Anfrage bieten wir jedoch auch Kurse in Englisch oder Italienisch an.</p>
        </details>
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
            ...
            <p class="text-gray-600 mt-4 text-sm">Nach erfolgreichem Abschluss des Motorrad-Grundkurses bei Driving Team Zug empfehlen wir, das Erlernte kontinuierlich zu üben, um dich optimal auf die praktische Führerscheinprüfung vorzubereiten. Um deine Fähigkeiten weiter zu verbessern und dich bestmöglich auf die Prüfungssituation einzustellen, bieten wir spezielle Prüfungsvorbereitungskurse oder Fahrstunden an, die eine Prüfungssimulation mit unseren erfahrenen Motorradfahrlehrern umfassen. Diese zusätzliche Vorbereitung kann dir helfen, mehr Sicherheit im Umgang mit dem Motorrad zu gewinnen und die Prüfung erfolgreich zu bestehen.</p>
          </details>
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">

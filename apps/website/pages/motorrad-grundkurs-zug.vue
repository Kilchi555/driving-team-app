    ...
    <section class="section-container">
      ...
      <div class="max-w-3xl mx-auto space-y-4">
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Für den Motorrad-Grundkurs bei Driving Team in Zug müssen Teilnehmende in der Regel ihr eigenes Fahrzeug mitbringen. Solltest du ein Motorrad oder einen Roller benötigen, bieten wir gegen eine Gebühr von CHF 80.- pro Kursteil die Möglichkeit, ein Fahrzeug auszuleihen. Bitte kontaktiere uns im Voraus.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Ja, beim Driving Team Zug ist es erforderlich, dass Teilnehmende ihre eigene Motorrad-Sicherheitsbekleidung, einschliesslich eines Motorradhelms, mitbringen. Solltest du keinen Helm oder Schutzkleidung besitzen, bieten wir eine begrenzte Anzahl an Helmen, Jacken und Hosen zur Miete an (CHF 10.- Umtriebsentschädigung pro Nutzung).</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">

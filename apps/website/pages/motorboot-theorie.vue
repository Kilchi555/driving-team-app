    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16 md:py-24">
      <div class="section-container">
        <div class="max-w-3xl">
          ...
          <p class="text-xl text-primary-100 mb-8">Wir bieten Dir die Möglichkeit, bei uns Motorboot Theoriestunden zu buchen und dich beim Lernen mit Tipps und Tricks zu unterstützen. Wer die Motorboot Theorie wirklich verstanden hat, braucht weniger Fahrstunden auf dem Wasser!</p>

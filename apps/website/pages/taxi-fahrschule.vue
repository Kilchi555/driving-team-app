    ...
    <section class="bg-gray-50 py-16">
      <div class="section-container">
        ...
        <div class="text-center mt-12">
          <a href="https://app.simy.ch/booking/availability/driving-team" target="_blank" rel="noopener noreferrer" class="btn-primary text-lg" aria-label="Taxi Fahrschule BPT jetzt buchen - Professional Taxi Training">

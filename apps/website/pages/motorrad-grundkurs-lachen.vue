<template>
  <div>
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/courses/motorrad-grundkurs-hero.webp" sizes="100vw" alt="Motorrad Grundkurs – Sicheres Fahren auf zwei Rädern lernen mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" loading="eager" fetchpriority="high" width="828" height="550" />
      <div class="absolute inset-0 bg-black/40"></div>
      <div class="section-container relative z-10">
        <div class="max-w-3xl">
          <h1 class="heading-lg text-white mb-4">Motorrad Grundkurs Lachen</h1>
          <p class="text-base xs:text-xl text-white mb-2">Kompletter Kurs in Lachen nur für <strong>CHF 570.–</strong> anstatt 630.-</p>
          ...
          <a href="https://app.simy.ch/customer/courses/driving-team/?category=PGS&location=Lachen" target="_blank" rel="noopener noreferrer" class="btn-primary bg-white text-primary-600 hover:bg-primary-50 text-lg">
            ✨ Jetzt anmelden
          </a>
        </div>
      </div>
    ...
    <section class="section-container">
      ...
      <div class="max-w-3xl mx-auto space-y-4">
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie viele Stunden umfasst der Motorrad-Grundkurs bei Driving Team in Lachen?<span class="text-primary-500 group-open:rotate-180 transition hover:text-primary-700">▼</span></summary>
          <p class="text-gray-600 mt-4 text-sm">Der Motorrad-Grundkurs bei Driving Team in Lachen umfasst insgesamt 12 Stunden, aufgeteilt in 3 Kursteile à 4 Stunden. Diese Struktur gewährleistet eine umfassende Ausbildung in allen wichtigen Bereichen des Motorradfahrens, von der Handhabung bis zur Verkehrssicherheit.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Ja, beim Driving Team Lachen ist es erforderlich, dass Teilnehmende ihre eigene Motorrad-Sicherheitsbekleidung, einschliesslich eines Motorradhelms, mitbringen. Der Helm ist gesetzlich vorgeschrieben, während weitere Schutzausrüstung wie Motorradbekleidung, Schuhe, Kombis oder Handschuhe dringend empfohlen, aber nicht zwingend erforderlich ist.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <div class="text-gray-600 mt-4 text-sm">
            ...
            <ul class="list-disc pl-5 space-y-1">
              <li><strong>Teil 1:</strong> Fahrzeugbeherrschung im Langsamfahrbereich, Parcours, Betriebssicherheit, Motorradbekleidung, gesetzliche Aspekte, Fahren im Verkehr (Abbiegen, Sicherheitsabstand).</li>
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Die Anmeldung für einen Motorrad-Grundkurs bei Driving Team in Lachen ist einfach und unkompliziert. Klicke auf einen der «Jetzt anmelden»-Buttons auf dieser Seite. Solltest du Fragen haben, stehen wir dir jederzeit per E-Mail oder telefonisch zur Verfügung.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie viel kostet der Motorrad-Grundkurs bei Driving Team in Lachen?<span class="text-primary-500 group-open:rotate-180 transition hover:text-primary-700">▼</span></summary>
          <p class="text-gray-600 mt-4 text-sm">Bei Driving Team in Lachen beträgt die Gebühr für jeden Kursteil des Motorrad-Grundkurses CHF 190.-. Diese Investition in deine Sicherheit stellt sicher, dass du bestens für die Teilnahme am Strassenverkehr vorbereitet bist.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
        ...
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
          ...
          <p class="text-gray-600 mt-4 text-sm">Der Treffpunkt für den Motorrad-Grundkurs von Driving Team befindet sich direkt vor unserem Lokal in Lachen: Herrengasse 17, 8853 Lachen/SZ (2 Gehminuten vom Bhf Lachen). Dort wirst du zu Beginn des Kurses von unseren Instruktoren begrüsst.</p>
        </details>
        <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer group">
    ...
    <section class="section-container py-12">
      <h2 class="text-xl font-bold text-center mb-8 text-gray-900">Weitere Angebote in Lachen & Umgebung</h2>
      <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-4xl mx-auto">
        ...
        <a href="/motorrad-grundkurs-zuerich/" class="bg-white border border-gray-200 rounded-xl p-5 hover:shadow-md hover:border-primary-300 transition group">
          <div class="text-2xl mb-2">📍</div>
          <p class="font-semibold text-gray-900 group-hover:text-primary-700 text-sm">Motorrad Grundkurs Zürich</p>
          <p class="text-xs text-gray-500 mt-1">CHF 499.- Komplettpreis</p>
        </a>
    ...
    <section class="bg-primary-600 text-white py-16">
      <div class="section-container text-center">
        <h2 class="heading-md mb-6 text-white">Jetzt Motorrad Grundkurs Lachen buchen!</h2>
        <div class="flex flex-col md:flex-row gap-4 justify-center">
          <a href="https://app.simy.ch/customer/courses/driving-team/?category=PGS&location=Lachen" target="_blank" rel="noopener noreferrer" class="btn-primary bg-white text-primary-600 hover:bg-primary-50 text-lg">📅 Jetzt anmelden</a>
...
const jsonLdScripts = [
  { type: 'application/ld+json', innerHTML:  JSON.stringify({ "@context": "https://schema.org", "@type": "Course", "name": "Motorrad Grundkurs Lachen", "description": "Motorrad Grundkurs in Lachen SZ. 3x4h für alle Kategorien, max. 5 Teilnehmer.", "url": "https://drivingteam.ch/motorrad-grundkurs-lachen/", "courseWorkload": "PT12H", "educationalLevel": "Beginner", "category": "Motorrad Fahrausbildung", "provider": { "@type": "Organization", "name": "Driving Team Fahrschule", "url": "https://drivingteam.ch", "telephone": "+41444310033", "address": { "@type": "PostalAddress", "streetAddress": "Herrengasse 17", "addressLocality": "Lachen", "postalCode": "8853", "addressRegion": "SZ", "addressCountry": "CH" } }, "offers": { "@type": "Offer", "price": "570", "priceCurrency": "CHF", "availability": "https://schema.org/InStock", "url": "https://app.simy.ch/customer/courses/driving-team/?category=PGS&location=Lachen" }, "hasCourseInstance": [{ "@type": "CourseInstance", "courseMode": "onsite", "courseSchedule": { "@type": "Schedule", "repeatFrequency": "P1W", "duration": "PT4H" }, "location": { "@type": "Place", "name": "Lachen SZ", "address": { "@type": "PostalAddress", "streetAddress": "Herrengasse 17", "addressLocality": "Lachen", "postalCode": "8853", "addressRegion": "SZ", "addressCountry": "CH" } } }] }) },
  { type: 'application/ld+json', innerHTML: JSON.stringify({"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": [{"@type": "Question", "name": "Was ist ein Motorrad-Grundkurs und warum ist er notwendig?", "acceptedAnswer": {"@type": "Answer", "text": "Ein Motorrad-Grundkurs bei Driving Team Lachen vermittelt essenzielle Fähigkeiten für sicheres Motorradfahren und ist gesetzlich vorgeschrieben."}}, {"@type": "Question", "name": "Wer muss einen Motorrad-Grundkurs in der Schweiz absolvieren?", "acceptedAnswer": {"@type": "Answer", "text": "Pflicht für alle, die einen Führerschein der Kategorie A1 oder A (beschränkt) anstreben."}}, {"@type": "Question", "name": "Wie viele Stunden umfasst der Motorrad-Grundkurs in Lachen?", "acceptedAnswer": {"@type": "Answer", "text": "Insgesamt 12 Stunden, aufgeteilt in 3 Kursteile à 4 Stunden."}}, {"@type": "Question", "name": "Wie viel kostet der Motorrad-Grundkurs in Lachen?", "acceptedAnswer": {"@type": "Answer", "text": "Der komplette Kurs kostet CHF 570.- (3 Teile à CHF 190.-)."}}, {"@type": "Question", "name": "Wo findet der Motorrad-Grundkurs in Lachen statt?", "acceptedAnswer": {"@type": "Answer", "text": "Der Kurs findet in Lachen/SZ statt. Der genaue Treffpunkt wird bei der Anmeldung mitgeteilt."}}, {"@type": "Question", "name": "Was passiert bei schlechtem Wetter?", "acceptedAnswer": {"@type": "Answer", "text": "Bei schlechten Wetterbedingungen kann der Kurs angepasst oder verschoben werden. Wir informieren die Teilnehmenden rechtzeitig."}}, {"@type": "Question", "name": "Welche Themen werden im Motorrad-Grundkurs behandelt?", "acceptedAnswer": {"@type": "Answer", "text": "Teil 1: Fahrzeugbeherrschung. Teil 2: Bremsmanöver und Verkehrsregeln. Teil 3: Kurvenfahren und Gruppenfahren."}}, {"@type": "Question", "name": "Welche Sprachen werden angeboten?", "acceptedAnswer": {"@type": "Answer", "text": "Der Kurs wird auf Deutsch durchgeführt. Auf Anfrage auch auf Englisch."}}, {"@type": "Question", "name": "Wie erhalte ich die unlimitierte Kategorie A?", "acceptedAnswer": {"@type": "Answer", "text": "Nach 2 Jahren Fahrpraxis mit beschränkter Kategorie A (35 kW) folgt eine weitere Prüfung für die unlimitierte Kategorie A."}}]}) },
  { type: 'application/ld+json', innerHTML:  JSON.stringify({ "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://drivingteam.ch/" }, { "@type": "ListItem", "position": 2, "name": "Motorrad Grundkurs", "item": "https://drivingteam.ch/motorrad-grundkurs/" }, { "@type": "ListItem", "position": 3, "name": "Lachen", "item": "https://drivingteam.ch/motorrad-grundkurs-lachen/" }] }) },
]

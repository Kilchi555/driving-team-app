<template>
  <div>
    ...
    <UpcomingCoursesSection
      ...
      :schema-meta="pgsLachenSchemaMeta"
    />
...
const pgsLachenSchemaMeta = {
  description: 'Motorrad Grundkurs in Lachen SZ. 3x4h für alle Kategorien, max. 5 Teilnehmer.',
  courseWorkload: 'PT12H',
  educationalLevel: 'Beginner',
  category: 'Motorrad Fahrausbildung',
  offerPrice: '570',
  offerUrl: 'https://app.simy.ch/customer/courses/driving-team/?category=PGS&location=Lachen',

    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16 md:py-24">
      <div class="section-container">
        <div class="max-w-3xl">
          ...
          <p class="text-xl text-white/90 mb-8">Im total achtstündigen VKU Kurs Lachen wirst Du ausführlich auf den Alltag im Strassenverkehr vorbereitet. Der Abschluss des Verkehrskunde Kurses ist obligatorisch und Voraussetzung für die Anmeldung an die Praktische Führerprüfung.</p>

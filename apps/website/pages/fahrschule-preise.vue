<template>
  <div>
    <Head>
      ...
      <Meta name="description" content="Alle Preise unserer Fahrschule auf einen Blick ✓ Kostenrechner für Fahrstunden ✓ Unverbindliche Offerte. Auto, Motorrad, Kurse – transparent & fair." />
    ...
    <section class="bg-primary-600 text-white py-16">
      <div class="section-container text-center">
        ...
        <div class="flex flex-col md:flex-row gap-4 justify-center">
          <a href="https://www.simy.ch/booking/availability/driving-team" target="_blank" rel="noopener noreferrer" class="btn-primary bg-white text-primary-600 hover:bg-primary-50 text-lg">📅 Online buchen</a>

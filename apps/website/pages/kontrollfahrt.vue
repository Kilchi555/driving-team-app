  ...
  <div>
    <Head>
      ...
      <Link rel="canonical" href="https://drivingteam.ch/kontrollfahrt/" />
          ...
          <Meta property="og:image" content="https://drivingteam.ch/images/categories/kontrollfahrt-hero.webp" />
    ...
    <section class="section-container py-20">
      <div class="max-w-4xl mx-auto">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div class="bg-primary-50 rounded-lg p-6">
            <h3 class="font-bold text-primary-800 mb-2">Online Zahlung</h3>
            <p class="text-gray-700 text-sm">Zahlbar online via Twint, Debit- oder Kreditkarte</p>
          </div>
        </div>

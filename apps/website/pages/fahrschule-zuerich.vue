      ...
      <div class="section-container relative z-10">
        ...
        <div class="max-w-3xl mx-auto space-y-4">
          ...
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer hover:shadow-md transition group">
            ...
            <p class="text-gray-600 mt-4">Unsere Lokale befinden sich in Zürich-Altstetten und in Lachen/SZ. Das Tätigkeitsgebiet des Driving Team Zürich erstreckt sich von Baden (Limmattal) bis nach Thalwil und von Bülach bis nach Wettswil/Bonstetten im Knonaueramt. Bei den Autofahrlektionen können wir nach Möglichkeit flexible Treffpunkte vereinbaren. Bei der Anhänger- und Motorradausbildung beschränkt sich der Treffpunkt auf Zürich-Altstetten. Seit ein paar Jahren geben wir auch im Zürcher Oberland rundum Uster Auto- und Motorradfahrstunden.</p>
          </details>
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer hover:shadow-md transition group">
            <summary class="font-semibold text-lg text-gray-900 flex justify-between items-center">
          ...
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer hover:shadow-md transition group">
            ...
            <div class="text-gray-600 mt-4">
              ...
              <ul class="list-disc pl-5 space-y-1">
                ...
                <li>Leimbach / Adliswil / Thalwil</li>
                <li>Sihlcity / Wettswil / Ringlikon</li>
                <li>Uitikon Waldegg / Birmensdorf</li>
                <li>Wiedikon / Albisrieden / Altstetten</li>
              </ul>
            </div>
          </details>
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer hover:shadow-md transition group">
          ...
          <details class="bg-white border border-gray-200 rounded-lg p-6 cursor-pointer hover:shadow-md transition group">
            <summary class="font-semibold text-lg text-gray-900 flex justify-between items-center">
              Wieviel betragen die ungefähren Gesamtkosten für die Auto Prüfung?
              <span class="text-gray-400 group-open:rotate-180 transition">▼</span>
            </summary>

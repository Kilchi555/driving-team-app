<template>
  <div>
    <Head>
      ...
      <Meta name="description" content="Anhängerprüfung Lachen SZ Kategorie BE ✓ Prüfungsort Pfäffikon SZ ✓ Kein Theorietest ✓ 2–4 Fahrstunden genügen ✓ Fahrzeug gestellt ✓ Jetzt buchen!" />
      ...
      <Meta property="og:description" content="Anhängerprüfung Lachen SZ: Prüfungsort Pfäffikon SZ. 2–4 Fahrstunden, kein Theorietest. Wir stellen Anhänger und Zugfahrzeug." />
      <Meta property="og:url" content="https://drivingteam.ch/anhaenger-pruefung-lachen/" />
      <Link rel="canonical" href="https://drivingteam.ch/anhaenger-pruefung-lachen/" />
      <Link rel="preload" as="image" href="/images/categories/anhaenger-fahrschule-hero.webp" fetchpriority="high" />
    ...
    <BreadcrumbNav :breadcrumbs="[{ label: 'Fahrschule', href: '/' }, { label: 'Anhänger Fahrschule', href: '/anhaenger-fahrschule/' }, { label: 'Anhängerprüfung', href: '/anhaenger-pruefung/' }, { label: 'Lachen SZ' }]" />
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/categories/anhaenger-fahrschule-hero.webp" alt="Anhängerprüfung Lachen SZ Kategorie BE – Prüfungsort Pfäffikon SZ mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" fetchpriority="high" loading="eager" width="1920" height="1080" />
    ...
    <!-- Prüfungszentrum Lachen -->
    <section class="py-14 bg-white">
      <div class="section-container">
        <div class="max-w-4xl mx-auto">
          <h2 class="heading-md text-center mb-4">Prüfungszentrum Anhänger Lachen SZ</h2>
          <p class="text-center text-gray-600 mb-10">Die Anhängerprüfung in der Region Lachen findet beim Strassenverkehrsamt Pfäffikon SZ statt.</p>
          <div class="max-w-2xl mx-auto">
            <div class="bg-white rounded-2xl p-8 shadow-sm border-2 border-primary-100">
              ...
              <ul class="space-y-2 text-sm text-gray-700 mb-4">
                ...
                <li class="flex items-center gap-2"><span class="text-primary-600 font-bold">✓</span> Parkierübungen rechtwinklig / parallel</li>
    ...
    <section class="py-14 bg-gray-50">
      <div class="section-container">
        <div class="max-w-3xl mx-auto">
          <h2 class="heading-md text-center mb-10">Ablauf – Weg zur Anhängerprüfung Lachen</h2>
          <div class="space-y-3">
            <div class="flex items-start gap-4 bg-white rounded-2xl p-5 border border-gray-100">
              ...
              <div><p class="font-semibold text-gray-900">Lernfahrausweis BE beantragen</p><p class="text-sm text-gray-600">Beim Strassenverkehrsamt Schwyz (STVA Pfäffikon SZ) – mit gültigem Kat. B Ausweis. Ca. CHF 30–40.</p></div>
            </div>
            <div class="flex items-start gap-4 bg-white rounded-2xl p-5 border border-gray-100">
            ...
            <div class="flex items-start gap-4 bg-white rounded-2xl p-5 border border-gray-100">
              ...
              <div><p class="font-semibold text-gray-900">Prüfungsanmeldung</p><p class="text-sm text-gray-600">Wir melden dich beim STVA Schwyz an. Wartezeit ca. 2–4 Wochen.</p></div>
            </div>
            <div class="flex items-start gap-4 bg-white rounded-2xl p-5 border border-gray-100">
              <div class="w-10 h-10 rounded-full bg-green-600 text-white flex items-center justify-center font-bold flex-shrink-0">✓</div>
              <div><p class="font-semibold text-gray-900">Praktische Prüfung & Führerausweis</p><p class="text-sm text-gray-600">Ca. 45 Min. Manöver + Strassenfahrt. Bestanden → sofort neuen Ausweis beantragen.</p></div>
            </div>
          </div>
        </div>
      </div>
    ...
    <section class="py-14 bg-white">
      <div class="section-container">
        <div class="max-w-3xl mx-auto bg-gray-50 rounded-2xl p-8 border border-gray-200">
          <h2 class="text-2xl font-bold text-gray-900 mb-6">Was brauche ich für die Prüfung?</h2>
          <div class="grid sm:grid-cols-2 gap-4">
            ...
            <div class="flex items-start gap-3">
              <span class="text-green-600 font-bold flex-shrink-0">✓</span>
              <p class="text-sm text-gray-700"><strong>Kein Nothelferkurs</strong>, keine Theorieprüfung</p>
            </div>
          </div>
          <div class="mt-6 p-4 bg-primary-50 rounded-xl border border-primary-100">
            <p class="text-sm text-primary-800">💡 Wir kümmern uns um die Prüfungsanmeldung beim STVA Schwyz. Du musst nichts organisieren.</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="py-16 bg-gray-50">
      <div class="section-container">
        <h2 class="heading-md mb-10 text-center">Fragen zur Anhängerprüfung Lachen</h2>
        <div class="max-w-3xl mx-auto space-y-4">
          <details class="bg-white border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
            <summary class="font-semibold text-gray-900 flex justify-between items-center">Wo findet die Anhängerprüfung ab Lachen statt?<span class="text-primary-500 group-open:rotate-180 transition">▼</span></summary>
            <p class="text-gray-600 mt-4 text-sm leading-relaxed">Die Anhängerprüfung für Fahrschüler aus Lachen, March und Umgebung findet beim Strassenverkehrsamt in Pfäffikon SZ statt.</p>
          </details>
          <details class="bg-white border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
            ...
            <p class="text-gray-600 mt-4 text-sm leading-relaxed">Nein. Wir stellen Anhänger und Zugfahrzeug für Fahrstunden und Prüfung bereit. Du erscheinst einfach mit deinem Führerausweis.</p>
          </details>
          <details class="bg-white border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
            <summary class="font-semibold text-gray-900 flex justify-between items-center">Wie lange dauert die Prüfung?<span class="text-primary-500 group-open:rotate-180 transition">▼</span></summary>
            <p class="text-gray-600 mt-4 text-sm leading-relaxed">Ca. 45 Minuten: Manöverübungen auf dem Prüfungsplatz (An-/Abkuppeln, Rückwärtsfahren, Parkieren), dann Strassenfahrt ca. 30 Minuten.</p>
          </details>
          <details class="bg-white border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
            ...
            <p class="text-gray-600 mt-4 text-sm leading-relaxed">Prüfungsgebühr STVA Schwyz ca. CHF 100–120. Lernfahrausweis BE ca. CHF 30–40. Fahrstunden ab CHF 95/Lektion. Gesamtkosten ab ca. CHF 500–700 je nach Stundenzahl.</p>
          </details>
        </div>
      </div>
    </section>
    ...
    <!-- CTA -->
    <section class="py-14 bg-primary-600 text-white">
      <div class="section-container text-center">
        <h2 class="text-2xl md:text-3xl font-bold mb-4">Jetzt zur Anhängerprüfung Lachen anmelden</h2>
...
const jsonLdScripts = [
  { type: 'application/ld+json', innerHTML: JSON.stringify({
    ...
    "@type": "FAQPage",
    "mainEntity": [
      { "@type": "Question", "name": "Wo findet die Anhängerprüfung ab Lachen statt?", "acceptedAnswer": { "@type": "Answer", "text": "Beim Strassenverkehrsamt in Pfäffikon SZ." } },
      ...
      { "@type": "Question", "name": "Was kostet die Anhängerprüfung in der Region Lachen?", "acceptedAnswer": { "@type": "Answer", "text": "Prüfungsgebühr ca. CHF 100–120, Lernfahrausweis ca. CHF 30–40, Fahrstunden ab CHF 95/Lektion. Gesamtkosten ab ca. CHF 500–700." } }
    ]
  }) },
  { type: 'application/ld+json', innerHTML: JSON.stringify({
    "@context": "https://schema.org",
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 4, "name": "Lachen SZ", "item": "https://drivingteam.ch/anhaenger-pruefung-lachen/" }
    ]
  }) }
]

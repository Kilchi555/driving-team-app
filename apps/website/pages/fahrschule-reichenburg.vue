<template>
  <div>
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/locations/reichenburg-hero.webp" alt="Fahrstunden in Reichenburg/SZ – Auto, Motorrad und Anhänger Fahrschule mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" />
      ...
      <div class="section-container relative z-10">
        <div class="max-w-3xl">
          ...
          <p class="hidden xs:block text-xl text-white mb-8">Melde Dich in unserer Fahrschule Reichenburg an – individuelle Ausbildung, flexible Treffpunkte und professionelle Fahrlehrer.</p>

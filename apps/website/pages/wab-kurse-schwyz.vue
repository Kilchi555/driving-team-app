    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-16 md:py-24">
      <div class="section-container">
        <div class="max-w-3xl">
          ...
          <p class="text-xl text-primary-100 mb-8">Die WAB Kurse im Kanton Schwyz werden in Tuggen SZ bei unserer Partnerfahrschule der Verkehrszentrum Tuggen AG durchgeführt. Die WAB Kurs Instruktor:innen zeigen euch mit viel Elan und Freude die wichtigsten Fahrtechniken und Manöver.</p>

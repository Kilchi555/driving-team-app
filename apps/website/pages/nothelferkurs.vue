<template>
  <div>
    <Head>
      <Title>Nothelferkurs Zürich – Obligatorisch & Günstig | Driving Team</Title>
    ...
    <section class="bg-gradient-to-br from-red-600 to-red-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/courses/nothelfer-hero.webp" alt="Nothelferkurs – Lebensrettende Erste Hilfe für Führerausweis mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" />

<template>
  <div>
    <Head>
      <Title>Lastwagen Theorie Zürich | 8 Kursteile | Driving Team</Title>
      <Meta name="description" content="LKW Theorie gezielt vorbereiten – Kategorien C1, C, D1, D in Zürich und Lachen. Gruppenkurs CHF 800.-, Einzelkurs CHF 1360.-. Jetzt anmelden!" />
      ...
      <Meta property="og:image:alt" :content="'Lastwagen Theorie Kategorie C – Driving Team'" />
    ...
    <section class="section-container py-20">
      ...
      <div class="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-xl border-2 border-primary-600 shadow-sm p-8 text-center">
          ...
          <ul class="text-left space-y-2 text-gray-600 text-sm">
            <li>✓ Lkw & Bus Theorie, Kategorie C1 / C / D1 / D</li>
            <li>✓ Kompletter Kurs inkl. Bögeln</li>
            <li>ℹ️ exkl. CHF 100.– für Theorie-Ordner</li>
          </ul>
        </div>
        <div class="bg-white rounded-xl border-2 border-gray-200 shadow-sm p-8 text-center hover:border-primary-600 transition">
          ...
          <details class="bg-gray-50 border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
            ...
            <div class="text-gray-600 mt-4">
              ...
              <ul class="list-disc list-inside space-y-1">
                ...
                <li>Inhaber:in der Kategorie B (mindestens Lernfahrausweis)</li>
                <li>Verkehrsmedizinische Untersuchung bestanden</li>
                <li>Im Besitz des Lernfahrausweises Kategorie C1, C, D1 oder D</li>
              </ul>
            </div>
          </details>
        </div>
    ...
    <section class="section-container py-20">
      <div class="max-w-2xl mx-auto">
        <h2 class="heading-md text-center mb-4">Lkw Theorie anmelden</h2>
...
const jsonLdScripts = [
  { type: 'application/ld+json', innerHTML:  JSON.stringify({ "@context": "https://schema.org", "@type": "Course", "name": "Lastwagen Theorie Kurs", "description": "Theorievorbereitung für Kategorien C1, C, D1, D.", "url": "https://drivingteam.ch/lastwagen-theorie/", "provider": { "@type": "Organization", "name": "Driving Team Fahrschule", "url": "https://drivingteam.ch" }, "offers": [{ "@type": "Offer", "name": "Gruppenkurs", "price": "800", "priceCurrency": "CHF" }, { "@type": "Offer", "name": "Einzelkurs", "price": "1360", "priceCurrency": "CHF" }] }) },
  { type: 'application/ld+json', innerHTML:  JSON.stringify({ "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://drivingteam.ch/" }, { "@type": "ListItem", "position": 2, "name": "Lastwagen Theorie", "item": "https://drivingteam.ch/lastwagen-theorie/" }] }) },
]

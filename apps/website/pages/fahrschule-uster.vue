<template>
  <div>
    <Head>
      ...
      <Meta name="description" content="Fahrlehrer Pascal im Zürcher Oberland – Auto & Motorrad, Prüfung Hinwil/Bassersdorf, ab CHF 95.-. Jetzt deine Fahrstunde in Uster buchen!" />
      ...
      <Link rel="preload" as="image" href="/images/locations/uster-hero.webp" fetchpriority="high" />
          ...
          <Meta property="og:image" content="https://drivingteam.ch/images/locations/uster-hero.webp" />
    ...
    <section class="bg-gradient-to-br from-primary-600 to-primary-800 text-white py-8 xs:py-16 md:py-24 relative overflow-hidden">
      <img src="/images/locations/uster-hero.webp" alt="Fahrstunden in Uster/ZH – Auto und Motorrad Fahrschule mit Driving Team" class="absolute inset-0 w-full h-full object-cover opacity-100" fetchpriority="high" loading="eager" width="1920" height="1080" />
      ...
      <div class="section-container relative z-10">
        <div class="max-w-3xl">
          ...
          <p class="text-base xs:text-xl text-white mb-8">Pascal gibt Fahrstunden in Uster und dem Zürcher Oberland – ab Bahnhof Uster oder flexibel nach Absprache. Auf Deutsch und Englisch.</p>
    ...
    <!-- 2. Features (weiß) -->
    <FeatureSection
      title="Warum Driving Team Uster?"
      subtitle="Melde Dich in unserer Fahrschule Uster an und Du kannst folgende Punkte von uns erwarten…"
    ...
    <section class="py-10 bg-gray-50 text-center">
      <div class="section-container">
        ...
        <PriceCalculator title="Kostenrechner Fahrschule Uster" />
      </div>
    </section>
    ...
    <div class="bg-gray-50">
      <LazyStandortMapSection location-key="uster" />
    </div>

    <!-- 4. Themen (weiß) -->
    <AusbildungsthemenSection location="Uster" />
    ...
    <section class="py-16 bg-white">
      <div class="section-container">
        ...
        <div class="faq-masonry">
          ...
          <details class="bg-gray-50 border border-gray-100 rounded-xl p-6 cursor-pointer hover:shadow-[0_4px_16px_rgba(1,158,229,0.25)] transition group">
            <summary class="font-semibold text-gray-900 flex justify-between items-center">Welches sind die häufigsten Prüfungsrouten ab Hinwil?<span class="text-primary-500 group-open:rotate-180 transition">▼</span></summary>
            <div class="text-gray-600 mt-4 text-sm leading-relaxed">
              <ul class="list-disc pl-5 space-y-1">
    ...
    <section class="py-12 bg-gray-50">
      <div class="section-container">
        <h2 class="text-xl font-semibold text-gray-900 mb-6">Passende Angebote in Uster</h2>

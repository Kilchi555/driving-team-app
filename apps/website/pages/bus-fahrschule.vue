  ...
  <div>
    ...
    <section class="bg-gray-50 py-16">
      <div class="section-container">
        ...
        <div class="text-center mt-12">
          <a href="https://app.simy.ch/booking/availability/driving-team?category=D" target="_blank" rel="noopener noreferrer" class="btn-primary text-lg">
            🚀 Jetzt anmelden!
          </a>
        </div>
      </div>
    ...
    <section class="bg-primary-600 text-white py-16">
      <div class="section-container text-center">
        ...
        <p class="text-base xs:text-xl text-white mb-8">Mit professioneller Ausbildung von Driving Team in Zürich</p>

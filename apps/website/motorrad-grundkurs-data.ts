// Motorrad Grundkurs Data - für alle Standorte
export const motorradGrundkursData = {
  zuerich: {
  ...
  lachen: {
    ...
    location: {
      ...
      lat: 47.0945,
      lng: 8.6714,
      mapUrl: 'https://maps.google.com/maps?q=47.0945,8.6714'
    }
  },
  zug: {
    ...
    location: {
      ...
      lat: 47.1697,
      lng: 8.5111,
      mapUrl: 'https://maps.google.com/maps?q=47.1697,8.5111'
    }
  },
  einsiedeln: {
    ...
    stats: { requirements: 4, details: 4, hours: '12h' },
    location: {
      address: 'Bennauerstrasse 48, 8836 Bennau',
      lat: 47.1083,
      lng: 8.7311,
      mapUrl: 'https://maps.google.com/maps?q=47.1083,8.7311'
    }
  }
}

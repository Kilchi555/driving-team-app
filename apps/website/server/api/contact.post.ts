          ...
          <td style="padding:28px 20px;">
            ...
            <table width="100%" cellspacing="0" cellpadding="0" style="background:#eff6ff;border-radius:8px;margin-bottom:24px;border-left:4px solid ${PRIMARY_COLOR};">
              <tr><td style="padding:14px 16px;">
                <p style="margin:0;font-size:13px;color:#1e40af;">Möchtest du direkt einen Termin buchen? <a href="https://app.simy.ch/booking/availability/driving-team" style="color:${PRIMARY_COLOR};font-weight:600;">Hier geht's zur Online-Buchung →</a></p>
              </td></tr>
            </table>

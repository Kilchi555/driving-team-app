        ...
        <div class="hidden 1200:flex gap-2 items-center">
          ...
          <div class="relative group">
            ...
            <div class="absolute left-0 mt-0 w-72 bg-white border border-gray-100 rounded-xl shadow-xl opacity-0 group-hover:opacity-100 transition hidden group-hover:block z-50 py-2">
              <a href="/auto-fahrschule-zuerich/" class="block px-5 py-3 text-gray-700 hover:text-primary-600 hover:bg-primary-50 transition rounded-lg mx-2 whitespace-nowrap">📍 Fahrschule Zürich</a>
              <a href="/fahrschule-altstetten/" class="block px-5 py-3 text-gray-700 hover:text-primary-600 hover:bg-primary-50 transition rounded-lg mx-2 whitespace-nowrap">📍 Fahrschule Altstetten</a>
      ...
      <div id="main-nav-menu" v-if="showDesktopMenu" class="1200:hidden fixed top-[72px] left-0 right-0 bg-white z-40 shadow-xl rounded-b-2xl max-h-[calc(100vh-72px)] overflow-y-auto">
        ...
        <nav class="pb-4">
          ...
          <div v-show="openSection === 'fahrschule'" class="pl-2 py-2 space-y-1">
            <a href="/auto-fahrschule-zuerich/" class="block text-sm text-gray-600 hover:text-primary-600 py-1.5" @click="showDesktopMenu = false">📍 Zürich</a>
            <a href="/fahrschule-altstetten/" class="block text-sm text-gray-600 hover:text-primary-600 py-1.5" @click="showDesktopMenu = false">📍 Altstetten</a>
      ...
      <div class="section-container py-12">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-gray-300">
              <li><a href="/auto-fahrschule-zuerich/" class="hover:text-white transition">Fahrschule Zürich</a></li>
              <li><a href="/fahrschule-altstetten/" class="hover:text-white transition">Fahrschule Altstetten</a></li>
          ...
          <div>
            ...
            <ul class="space-y-2 text-sm text-gray-300">
              ...
              <li><a href="https://www.ninakae.ch" target="_blank" rel="nofollow noopener noreferrer" class="hover:text-white transition">Fotos von Nina Kälin</a></li>
            </ul>
          </div>
        ...
        <div class="border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div class="flex items-center gap-4">
            <!-- Instagram Zürich -->
            <a href="https://www.instagram.com/fahrschule_driving_team_zurich/" target="_blank" rel="nofollow noopener noreferrer" aria-label="Instagram Zürich" class="text-gray-400 hover:text-white transition">
              ...
              <span class="sr-only">Instagram Driving Team Zürich</span>
            </a>
            <!-- Instagram Lachen -->
            <a href="https://www.instagram.com/fahrschule_drivingteam_lachen" target="_blank" rel="nofollow noopener noreferrer" aria-label="Instagram Lachen" class="text-gray-400 hover:text-white transition">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg>
              <span class="sr-only">Instagram Driving Team Lachen</span>
            </a>
            <!-- Facebook Zürich -->
            <a href="https://www.facebook.com/drivingteam" target="_blank" rel="nofollow noopener noreferrer" aria-label="Facebook Zürich" class="text-gray-400 hover:text-white transition">
              ...
              <span class="sr-only">Facebook Driving Team Zürich</span>
            </a>
            <!-- Facebook Lachen -->
            <a href="https://www.facebook.com/drivingteamlachen/" target="_blank" rel="nofollow noopener noreferrer" aria-label="Facebook Lachen" class="text-gray-400 hover:text-white transition">
              <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              <span class="sr-only">Facebook Driving Team Lachen</span>
            </a>
            <!-- YouTube -->
            <a href="https://www.youtube.com/channel/UC5nqMUHvHym4xW-ro1aX90Q" target="_blank" rel="nofollow noopener noreferrer" aria-label="YouTube" class="text-gray-400 hover:text-white transition">
              ...
              <span class="sr-only">YouTube Driving Team</span>
            </a>
            <!-- TikTok -->
            <a href="https://www.tiktok.com/@drivingteam.ch" target="_blank" rel="nofollow noopener noreferrer" aria-label="TikTok" class="text-gray-400 hover:text-white transition">
              ...
              <span class="sr-only">TikTok Driving Team</span>
            </a>
          </div>

          <p class="text-gray-400 text-xs">
            Designed by 
            <a href="https://www.simy.ch" target="_blank" rel="nofollow noopener noreferrer" class="hover:text-white transition">Simy IT Systems Kilchenmann</a>
          </p>
        </div>
      </div>
    </footer>

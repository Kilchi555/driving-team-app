...
async function testImageAccess() {
  logger.debug('🖼️ Testing image access...');
  ...
  logger.debug('🔗 Testing URL:', imageUrl);
  ...
  try {
    ...
    img.onload = () => {
      ...
      logger.debug('📏 Dimensions:', img.width, 'x', img.height);
    };
    img.onerror = () => {
    ...
    logger.debug('🎉 Image access test completed!');

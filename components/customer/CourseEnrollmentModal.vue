          ...
          <div v-else-if="step === 'contact'">
            ...
            >
              ...
              <p class="text-sm text-blue-800">
                <strong>Rechnung</strong> — du erhältst die Rechnung nach der Anmeldung per E-Mail. Keine Vorauszahlung nötig.
              </p>
            </div>
            <div
...
const paymentMethod = computed(() => {
  ...
  // UI and API in sync.
  return getCoursePaymentMethod(props.course as any, walleeEnabled.value, invoiceEnabled.value)
})
...
const submitEnrollment = async () => {
  ...
  try {
    ...
    const nonWalleePaymentMethod = paymentMethod.value === 'INVOICE' ? 'invoice' : 'cash_on_site'

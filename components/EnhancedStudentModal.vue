      ...
      <div class="flex-1 overflow-y-auto">
        ...
        <div v-if="activeTab === 'documents'" class="p-4 space-y-6">
          ...
          <div class="bg-white border border-gray-200 rounded-lg p-6">
            ...
            <!-- Upload Button - Camera & File Options -->
            <div class="flex gap-3">
              <!-- Camera Button -->
              <button
                @click="cameraInput?.click()"
                class="flex-1 border-2 border-dashed border-blue-300 rounded-lg p-4 text-center cursor-pointer hover:border-blue-500 hover:bg-blue-50 transition-colors"
              >
                <svg class="w-6 h-6 mx-auto text-blue-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"></path>
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"></path>
                </svg>
                <p class="text-sm text-blue-600 font-medium">Foto machen</p>
                <p class="text-xs text-blue-500 mt-1">Mit Kamera</p>
              </button>
              
              <!-- File Button -->
              <button
                @click="documentFileInput?.click()"
                class="flex-1 border-2 border-dashed border-gray-300 rounded-lg p-4 text-center cursor-pointer hover:border-gray-500 hover:bg-gray-50 transition-colors"
              >
                <svg class="w-6 h-6 mx-auto text-gray-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                </svg>
                <p class="text-sm text-gray-600 font-medium">Datei wählen</p>
                <p class="text-xs text-gray-500 mt-1">Aus Galerie/Speicher</p>
              </button>
            </div>

<template>
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto admin-modal">
...
const form = ref({
  ...
  min_amount_rappen: 0,
  applies_to: 'all' as 'all' | 'specific_categories',
  category_filter: [] as string[],
  trigger_type: 'manual' as 'manual' | 'birthday' | 'milestone' | 'seasonal' | 'anniversary',

...
v-if="(getAppointmentById(appointmentId)?.discount_amount || 0) > 0" 
              ...
              <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                ...
                >
                  <svg v-if="isCreatingInvoice" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"/>
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
                  </svg>
                  <span v-else>An Accounto senden</span>
                </button>
                ...
                >
                  ...
                  <span v-else>Per E-Mail versenden</span>
                </button>
                
                <button
                  type="button"
                  :disabled="isCreatingInvoice"
                  class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-purple-600 text-base font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 disabled:opacity-50 sm:ml-3 sm:w-auto sm:text-sm"
                ...
                >
                  <svg v-if="isCreatingInvoice" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                    ...
                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"/>
                                          ...
                                          <span v-else>PDF erstellen</span>
                </button>
                ...
                >
                  ...
                  <span v-else>In Datenbank speichern + PDF</span>
                </button>
...
v-for="appointment in filteredAppointments" :key="appointment.id" 
                  ...
                  <td class="px-6 py-4 text-sm text-gray-900">
                    <div class="max-w-xs">
                      <div class="truncate font-medium">{{ appointment.event_type_code ? getEventTypeLabel(appointment.event_type_code) : appointment.title }}</div>

-- Standard Categories Templates erstellen (KORRIGIERT)
...
-- WICHTIG: Keine explizite ID setzen, da die Tabelle "generated by default as identity" verwendet

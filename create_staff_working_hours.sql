...
-- Policy: Staff können ihre eigenen Arbeitszeiten sehen und verwalten
...
-- 5. Beispiel-Daten (optional)
-- INSERT INTO staff_working_hours (staff_id, day_of_week, start_time, end_time) VALUES
-- ('staff-uuid-1', 1, '07:00', '18:00'), -- Montag
-- ('staff-uuid-1', 2, '07:00', '18:00'), -- Dienstag
-- ('staff-uuid-1', 3, '07:00', '18:00'), -- Mittwoch
-- ('staff-uuid-1', 4, '07:00', '18:00'), -- Donnerstag
-- ('staff-uuid-1', 5, '07:00', '18:00'); -- Freitag

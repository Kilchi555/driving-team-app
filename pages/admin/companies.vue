    ...
    <Teleport to="body">
      <div v-if="modalOpen" class="fixed inset-0 bg-black/50 flex items-end sm:items-center justify-center z-50 p-0 sm:p-4"
        ...
        <div class="bg-white rounded-t-3xl sm:rounded-2xl w-full max-w-2xl max-h-[95dvh] overflow-y-auto">
          ...
          <!-- Details Tab -->
          <form v-if="!editingCompany?.id || detailTab === 'Details'" @submit.prevent="saveCompany" class="p-5 space-y-5">
            ...
            <div class="space-y-3">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label class="block text-xs font-medium text-gray-600 mb-1">Ansprechperson</label>
                ...
                <div>
                  ...
                  <input v-model="form.phone" type="tel" placeholder="+41 44 000 00 00"
                    class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 bg-gray-50 focus:bg-white transition-colors" />
                </div>
              </div>
              <div>
            ...
            <!-- Adresse -->
            <div class="space-y-3">
              <p class="text-xs font-semibold text-gray-400 uppercase tracking-widest">Adresse</p>
              <div class="grid grid-cols-4 gap-2">
                <div class="col-span-3">
                  <label class="block text-xs font-medium text-gray-600 mb-1">Strasse</label>
                  <input v-model="form.street" type="text" placeholder="Musterstrasse"
                    class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 bg-gray-50 focus:bg-white transition-colors" />
                </div>
                <div>
                  <label class="block text-xs font-medium text-gray-600 mb-1">Nr.</label>
                  <input v-model="form.street_nr" type="text" placeholder="12"
                    class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 bg-gray-50 focus:bg-white transition-colors" />
                </div>
              </div>
              <div class="grid grid-cols-3 gap-2">
                <div>
                  ...
                  <input v-model="form.zip" type="text" placeholder="8000"
                    class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 bg-gray-50 focus:bg-white transition-colors" />
                </div>
                <div class="col-span-2">
                  <label class="block text-xs font-medium text-gray-600 mb-1">Ort</label>
                  <input v-model="form.city" type="text" placeholder="Zürich"
                    class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 bg-gray-50 focus:bg-white transition-colors" />
                </div>
              </div>
            </div>
            ...
            <!-- Rechtliches -->
            <div class="space-y-3">
              <p class="text-xs font-semibold text-gray-400 uppercase tracking-widest">Rechtliches</p>
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label class="block text-xs font-medium text-gray-600 mb-1">UID (MwSt-Nummer)</label>
                ...
                <div>
                  ...
                  <input v-model="form.company_register_number" type="text" placeholder="CH-020.3.000.000-0"
                    class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 bg-gray-50 focus:bg-white transition-colors" />
                </div>
              </div>
            </div>
            ...
            <!-- Notizen -->
            <div class="space-y-3">
              <p class="text-xs font-semibold text-gray-400 uppercase tracking-widest">Notizen</p>
              <textarea v-model="form.notes" rows="2" placeholder="Interne Notizen…"
                class="w-full px-3 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-200 bg-gray-50 focus:bg-white transition-colors resize-none" />
            </div>

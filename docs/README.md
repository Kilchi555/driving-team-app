...
| [TEACHING_GUIDE.md](./TEACHING_GUIDE.md) | Evaluation → Unterrichts-Guide, Kat B seeds, `can_edit_guide` |
| [EVENT_DURATION_LOCK.md](./EVENT_DURATION_LOCK.md) | Staff-chosen duration must not snap back; paid duration edits |
| [SARI_CHECKOUT_RACES.md](./SARI_CHECKOUT_RACES.md) | SARI test-enroll leftovers, open-checkout sync skip, webhook re-enroll |

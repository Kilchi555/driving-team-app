...
| [SARI_LICENSE_EXPIRATION.md](./SARI_LICENSE_EXPIRATION.md) | SARI license ABSENT vs dated expiration (#245; supersedes #241 deny-on-null) |
| [DISCOUNT_FIXED_CHF_UNITS.md](./DISCOUNT_FIXED_CHF_UNITS.md) | `discounts.fixed` CHF vs voucher rappen before Wallee (#246) |
| [COURSE_PARTICIPANT_IDENTITY.md](./COURSE_PARTICIPANT_IDENTITY.md) | VKU roster birthdate / LFA display (#242) |

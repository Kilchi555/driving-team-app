...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      htmlAttrs: { lang: 'de' },
      meta: [
        { name: 'description', content: 'Simy – Online-Buchung für Terminbetriebe. Termine, Kurse und Kundenverwaltung in einer App.' },
        { name: 'keywords', content: 'Online buchen, Terminbuchung, Simy' },
        { name: 'theme-color', content: '#7C3AED' },
        { name: 'robots', content: 'noindex, nofollow' },
        { property: 'og:title', content: 'Simy – Online buchen' },
        { property: 'og:description', content: 'Termine und Kurse online buchen. Betriebsoftware für Schweizer Terminbetriebe.' },
        { property: 'og:type', content: 'website' },
        { property: 'og:site_name', content: 'Simy' },
        { property: 'og:locale', content: 'de_CH' },
        { property: 'og:url', content: 'https://app.simy.ch/' },
        { property: 'og:image', content: 'https://app.simy.ch/simy-logo.png' },
        { property: 'og:image:width', content: '1200' },
        { property: 'og:image:height', content: '630' },
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: 'Simy – Online buchen' },
        { name: 'twitter:description', content: 'Termine und Kurse online buchen. Betriebsoftware für Schweizer Terminbetriebe.' },
        { name: 'twitter:image', content: 'https://app.simy.ch/simy-logo.png' },
      ],
      link: [
        { rel: 'icon', type: 'image/png', href: '/simy-favicon.png' },
        { rel: 'apple-touch-icon', href: '/simy-favicon.png' },
        { rel: 'canonical', href: 'https://app.simy.ch/' },
      ],
      script: [

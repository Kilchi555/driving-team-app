  ...
  nitro: {
    ...
    headers: {
      ...
      'Content-Security-Policy': [
        ...
        "connect-src 'self' https://unyjaetebnaexaflpyoc.supabase.co https://kssqalisscxkhvorqwgy.supabase.co https://maps.googleapis.com https://api.resend.com https://app-wallee.com wss://unyjaetebnaexaflpyoc.supabase.co wss://kssqalisscxkhvorqwgy.supabase.co https://www.facebook.com https://connect.facebook.net",

-- Finale Migration für das Bewertungssystem
-- Berücksichtigt bestehende Abhängigkeiten
...
-- 5. Füge Beispieldaten hinzu (nur wenn noch keine vorhanden sind)
...
-- 6. Füge Kriterien hinzu (nur wenn noch keine vorhanden sind)
...
-- 7. Füge Motorrad-Kategorien hinzu (falls gewünscht)
INSERT INTO evaluation_categories (name, description, color, display_order, driving_categories) 
SELECT * FROM (VALUES
...
-- 8. Erstelle oder aktualisiere den View
...
-- 9. Erstelle Trigger für updated_at (falls noch nicht vorhanden)
DO $$
BEGIN

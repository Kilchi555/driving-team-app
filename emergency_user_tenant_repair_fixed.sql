-- ========================================
-- EMERGENCY USER-TENANT REPAIR (FIXED)
-- ========================================
...
-- ========================================
-- STEP 4: EMERGENCY TENANT ASSIGNMENT (FIXED)
-- ========================================

-- If user exists but has no tenant_id, assign to "Deine Fahrschule"
UPDATE users 
SET tenant_id = '78af580f-1670-4be3-a556-250339c872fa'  -- Deine Fahrschule
WHERE auth_user_id = auth.uid()
...
-- ========================================
-- STEP 7: VERIFY STRICT TENANT ISOLATION
-- ========================================

-- Test our strict tenant function
SELECT 
    'STRICT_TENANT_TEST' as test_type,
    *
...
BEGIN
    ...
    RAISE NOTICE '4. Test that tenant switching is prevented';
    RAISE NOTICE '========================================';
END $$;

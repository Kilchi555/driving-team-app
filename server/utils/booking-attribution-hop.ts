 ...
 *
 * Keep in sync with apps/website/utils/booking-attribution-hop.ts
 * (website is a separate Vercel project and cannot import this file).
 */

import {
  mergeAttributionFields,
  type AttributionFields,
} from './marketing-attribution-merge'

...
const VARIANTS: Variant[] = [
  ...
  },
  {
    ...
    headlines: [
      { text: 'Erste Lektion CHF 65', pinnedField: 'HEADLINE_1' },
    ...
    descriptions: [
      { text: 'Erste Auto-Lektion 45 Min. für CHF 65 statt 95. Danach klar CHF 95.–.', pinnedField: 'DESCRIPTION_1' },

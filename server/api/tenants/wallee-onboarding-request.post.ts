...
const HRA_BY_CANTON: Record<string, { name: string; address: string; url: string }> = {
  ZH: { name: 'Handelsregisteramt Kanton Zürich',        address: 'Schöntalstrasse 5, 8022 Zürich',            url: 'https://www.zh.ch/de/direktion-der-justiz-und-des-innern/handelsregisteramt.html' },
  BE: { name: 'Handelsregisteramt Kanton Bern',          address: 'Poststrasse 25, 3071 Ostermundigen',        url: 'https://www.hra.dij.be.ch' },
  LU: { name: 'Handelsregister Kanton Luzern',           address: 'Bundesplatz 14, 6002 Luzern',               url: 'https://handelsregister.lu.ch' },
  UR: { name: 'Handelsregisteramt Kanton Uri',           address: 'Bahnhofstrasse 1, 6460 Altdorf',            url: 'https://www.ur.ch/wirtschaft/1271' },
  SZ: { name: 'Handelsregisteramt Kanton Schwyz',        address: 'Bahnhofstrasse 15, 6431 Schwyz',            url: 'https://www.sz.ch/behoerden/gerichte/handelsregister.html' },
  OW: { name: 'Handelsregister Kanton Obwalden',         address: 'St. Antonistrasse 4, 6060 Sarnen',          url: 'https://www.ow.ch/fachbereiche/1876' },
  NW: { name: 'Handelsregisteramt Kanton Nidwalden',     address: 'Stansstaderstrasse 54, 6371 Stans',         url: 'https://www.nw.ch/hregamt' },
  GL: { name: 'Handelsregisteramt Kanton Glarus',        address: 'Zwinglistrasse 6, 8750 Glarus',             url: 'https://glarus.ch-handelsregister.ch' },
  ZG: { name: 'Handelsregisteramt Kanton Zug',           address: 'Industriestrasse 24, 6300 Zug',             url: 'https://zg.ch/de/volkswirtschaftsdirektion/handelsregister-und-konkursamt/handelsregisteramt' },
  FR: { name: 'Service du registre du commerce Fribourg', address: 'Boulevard de Pérolles 25, 1701 Fribourg',  url: 'https://www.fr.ch/deef/src' },
  SO: { name: 'Handelsregisteramt Kanton Solothurn',     address: 'Wengimattstrasse 2, 4710 Klus-Balsthal',    url: 'https://so.ch/verwaltung/finanzdepartement/kantonales-handelsregister' },
  BS: { name: 'Handelsregisteramt Kanton Basel-Stadt',   address: 'Claramattweg 8, 4057 Basel',                url: 'https://www.bs.ch/jsd/zentraler-rechtsdienst/handelsregisteramt' },
  BL: { name: 'Handelsregisteramt Kanton Basel-Landschaft', address: 'Domplatz 13, 4144 Arlesheim',            url: 'https://www.baselland.ch/politik-und-behorden/direktionen/sicherheitsdirektion/zivilrechtsverwaltung/handelsregisteramt' },
  SH: { name: 'Handelsregisteramt Kanton Schaffhausen',  address: 'Mühlentalstrasse 105, 8200 Schaffhausen',   url: 'https://handelsregister.sh.ch' },
  AR: { name: 'Handelsregisteramt Kanton Appenzell A.Rh.', address: 'Obstmarkt 3, 9102 Herisau',               url: 'https://ar.ch/verwaltung/departement-bau-und-volkswirtschaft/amt-fuer-wirtschaft-und-arbeit/handelsregister' },
  AI: { name: 'Handelsregisteramt Kanton Appenzell I.Rh.', address: 'Marktgasse 2, 9050 Appenzell',            url: 'https://www.ai.ch/verwaltung/volkwirtschaftsdepartement/handelsregisteramt' },
  SG: { name: 'Amt für Handelsregister Kanton St. Gallen', address: 'Davidstrasse 27, 9001 St. Gallen',        url: 'https://www.sg.ch/recht/handelsregister-notariate/handelsregister.html' },
  GR: { name: 'Handelsregisteramt Kanton Graubünden',    address: 'Ringstrasse 10, 7001 Chur',                 url: 'https://www.gr.ch/DE/institutionen/verwaltung/dvs/giha/ueberuns/Seiten/StandortundAdresse.aspx' },
  AG: { name: 'Handelsregisteramt Kanton Aargau',        address: 'Bahnhofplatz 3c, 5001 Aarau',               url: 'https://www.ag.ch/de/verwaltung/dvi/handelsregister' },
  TG: { name: 'Handelsregisteramt Kanton Thurgau',       address: 'Bahnhofstrasse 65, 8510 Frauenfeld',        url: 'https://handelsregister.tg.ch' },
  TI: { name: 'Ufficio del registro di commercio Ticino', address: 'Via Tognola 7, 6710 Biasca',               url: 'https://www4.ti.ch/di/dg/rf/contatti/ufficio-del-registro-di-commercio' },
  VD: { name: 'Office du registre du commerce Vaud',     address: 'Rue Grenade 38, 1510 Moudon',               url: 'https://www.vd.ch/economie/registre-du-commerce' },
  VS: { name: 'Office du registre du commerce Valais central', address: 'Place du Midi 30, 1951 Sion',         url: 'https://www.vs.ch/web/ext-rc/contacts' },
  NE: { name: 'Office du registre du commerce Neuchâtel', address: 'Rue de Tivoli 5, 2002 Neuchâtel',          url: 'https://www.ne.ch/autorites/decs/neco/ocrc' },
  GE: { name: 'Registre du commerce Genève',             address: 'Rue du Puits-Saint-Pierre 4, 1204 Genève',  url: 'https://www.ge.ch/organisation/ocirt-registre-du-commerce-rc' },
  JU: { name: 'Office du registre du commerce Jura',     address: 'Rue de la Justice 2, 2800 Delémont',        url: 'https://www.jura.ch/fr/Autorites/Juridique/Registre-foncier-et-registre-du-commerce.html' },
}
